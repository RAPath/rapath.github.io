...
sidebar_position: 1
title: Introduction
description: A plain-English regulatory reference for medical devices in Russia, covering Roszdravnadzor registration, classification, post-market obligations, and the EAEU pathway.
---
...
:::info Official regulator
**Roszdravnadzor (RZN)** — Federal Service for Surveillance in Healthcare  
Website: [roszdravnadzor.gov.ru](https://roszdravnadzor.gov.ru/)  
Under: Ministry of Health of the Russian Federation — [minzdrav.gov.ru](https://minzdrav.gov.ru/)
:::
...
- [GRLS State Register](https://grls.rosminzdrav.ru/GRLS.aspx)
