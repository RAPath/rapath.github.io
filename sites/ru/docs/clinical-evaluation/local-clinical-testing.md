---
title: Local Clinical Testing in Russia
sidebar_position: 2
description: When local clinical testing in Russia is required, how the process works, and National Ethics Committee approval requirements.
---
...
Key steps:
1. Prepare clinical investigation protocol
2. Submit to National Ethics Committee for review
3. Obtain Ethics Committee approval
4. Roszdravnadzor lifts the Phase 1 hold on the registration application
5. Investigation conducted in approved Russian clinical centres
6. Clinical data compiled and submitted to Roszdravnadzor (Phase 2)
