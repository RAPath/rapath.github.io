---
sidebar_position: 1
title: ANVISA GMP Inspections (Inspeções Sanitárias)
description: ANVISA GMP Inspections (Inspeções Sanitárias) — ANVISA medical device regulation in Brazil.
...
1. Opening meeting — inspectors present and review inspection scope.
2. Documentation review — quality system documents, SOPs, records.
3. Facility walk-through — production areas, warehouse, cleanrooms, laboratories.
4. Personnel interviews.
5. Closing meeting — inspectors summarise findings.
6. Inspection report — issued by ANVISA with any non-conformities.
7. Corrective action — manufacturer responds to non-conformities within the stated timeframe.
