---
sidebar_position: 1
title: Distributor AFE & Operating Licence Requirements
description: Distributor AFE & Operating Licence Requirements — ANVISA medical device regulation in Brazil.
...
1. **ANVISA AFE** for distribution activities;
2. **Municipal Licença de Funcionamento** for each distribution warehouse; and
3. A registered **Responsável Técnico** (in most cases).
