---
sidebar_position: 1
title: Exporting from Brazil — CFG (Free Sale Certificate)
description: Exporting from Brazil — CFG (Free Sale Certificate) — ANVISA medical device regulation in Brazil.
...
:::info BR-unique
Brazilian manufacturers and importers wishing to **export** medical devices to other countries often need a **Certificado de Exportação** (*CFG — Certificate to Foreign Government*), also commonly referred to as a **Free Sale Certificate (FSC)**.
:::
...
2. Select "Certificado de Exportação — Produto para Saúde."
3. Provide the ANVISA registration number and device details.
4. Pay the applicable fee.
5. ANVISA issues the CFG (typically within a few weeks).
