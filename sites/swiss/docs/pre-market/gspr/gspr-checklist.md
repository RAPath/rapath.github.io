---
sidebar_position: 2
description: How to structure a GSPR compliance matrix for Swiss MedDO devices — columns, handling non-applicable requirements, standards mapping, and gap analysis.
keywords: [GSPR checklist, compliance matrix, MedDO, harmonised standards, gap analysis]
---
...
| Column | Content |
|---|---|
| GSPR Reference | Specific Annex I section (e.g. "Chapter II, § 10.3") |
