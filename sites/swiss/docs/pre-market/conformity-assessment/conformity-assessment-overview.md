---
sidebar_position: 1
description: Overview of conformity assessment routes for Swiss medical devices under MedDO — routes by class, the Annex structure, and how the MRA affects the process.
keywords: [conformity assessment, MedDO, routes by class, Annex IX X XI, Switzerland]
---
...
## Official Sources
- [MedDO Annexes IV–XI (SR 812.213)](https://www.fedlex.admin.ch/eli/cc/2021/205/en)
- [Swissmedic — Conformity assessment](https://www.swissmedic.ch/swissmedic/en/home/medical-devices/market-access/conformity-assessment.html)
