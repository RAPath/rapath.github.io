---
sidebar_position: 3
description: Practical impact of the CH–EU MRA Chapter 4 on Swiss market access — when CE marking is sufficient, when separate registration is required, and the practical decision checklist.
---
