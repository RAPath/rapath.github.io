---
sidebar_position: 4
description: Cybersecurity for medical devices in Switzerland — regulatory obligations overview, IEC 81001-5-1, MDCG 2019-16, pre- and post-market requirements, and incident reporting.
keywords: [cybersecurity, medical device security, IEC 81001-5-1, MedDO, Switzerland, MDCG 2019-16]
---
# Cybersecurity in Switzerland

## Overview
Cybersecurity is a safety requirement for medical devices that contain software or are connected to other systems. This page provides an overview of Swiss cybersecurity requirements for medical devices. For the pre-market technical documentation requirements in detail, see [Cybersecurity Requirements](../pre-market/gspr/cybersecurity.md).

## Regulatory Basis
MedDO Annex I § 17.2–17.4 establishes cybersecurity requirements: devices with software or connectivity must achieve IT security appropriate to their intended purpose, protect against unauthorised access affecting device operation or safety, maintain documented minimum security requirements, and implement a cybersecurity lifecycle management process.
...
- [IEC 81001-5-1:2021](https://www.iec.ch)
