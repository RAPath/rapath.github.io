---
sidebar_position: 2
description: Periodic Safety Update Report (PSUR) for Swiss MedDO devices — when required (Class IIa and above), content, frequency, and submission to notified body and Swissmedic.
keywords: [PSUR, Periodic Safety Update Report, MedDO, Class IIa IIb III, Switzerland]
---
