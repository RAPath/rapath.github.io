---
sidebar_position: 1
description: Post-market surveillance overview for Swiss MedDO devices — PMS plan requirements, PMS report vs PSUR, data sources, and the feedback loop to technical documentation.
keywords: [post-market surveillance, PMS plan, PMS report, PSUR, MedDO, Switzerland]
---
# PMS Overview
