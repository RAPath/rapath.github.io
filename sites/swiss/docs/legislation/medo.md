---
sidebar_position: 2
description: MedDO (SR 812.213) — the Swiss ordinance governing medical devices, mirroring EU MDR 2017/745. Structure, all annexes, entry into force, and transitional provisions.
---
...
| Annex II | Technical documentation — general |
| Annex III | Technical documentation — post-market follow-up |
| Annex IV | Declaration of Conformity |
| Annex V | CE marking |
| Annex VI | Information to be submitted upon registration |
| Annex VII | Requirements to be met by conformity assessment bodies |
...
| Annex XII | Certificates issued by a conformity assessment body |
