---
sidebar_position: 4
description: ClinO-MD (SR 810.305) — the Swiss ordinance governing clinical investigations of medical devices, including Swissmedic authorisation, BASEC ethics, and sponsor obligations.
---
...
Add to the 'Key Requirements' section:
...
Remove the second 'Key Requirements' heading that appears before the 'Timelines' section. The heading structure should be:
...
With no duplication of section headings.
