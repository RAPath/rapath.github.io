---
title: "Digital Therapeutics (DTx) Regulation"
description: "Regulatory requirements for digital therapeutics in Korea."
sidebar_position: 5
---

**Digital Therapeutics (DTx, 디지털 치료기기)** are evidence-based software interventions used to prevent, manage, or treat a medical condition. Korea is one of the first countries globally to establish a **dedicated regulatory pathway** for DTx.

## MFDS approach to DTx

MFDS classifies DTx as SaMD when they meet the intended use criteria for a medical device. Key considerations:

- **Active therapeutic intent** — the software must deliver a clinical intervention, not just information
- **Evidence requirements** — clinical trial evidence of efficacy required for 품목허가
- **Grade assignment** — typically Grade II or III depending on the condition being treated

## Notable Korean DTx approvals
