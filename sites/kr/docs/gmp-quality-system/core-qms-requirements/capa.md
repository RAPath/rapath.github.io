...
description: "KGMP requirements for corrective and preventive action systems."
sidebar_position: 6
---
...
1. Review and document the nonconformity
2. Determine the cause (root cause analysis)
3. Evaluate the need for action to prevent recurrence
...
## Common MFDS inspection findings in CAPA
