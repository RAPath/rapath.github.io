---
title: Manufacturer's Evidence
description: What manufacturer's evidence is, when it must be submitted and accepted before an ARTG application can proceed, and how to manage it over time.
sidebar_position: 4
...
1. **Manufacturer evidence submission** — the sponsor submits the manufacturer's conformity assessment documents to the TGA
2. **ARTG inclusion application** — once the manufacturer evidence is accepted, the sponsor submits the application for ARTG inclusion
...
👉 [Required evidence by device class — TGA guidance](https://www.tga.gov.au/resources/guidance/using-assessments-comparable-overseas-regulators-medical-devices)
