...
description: How Australia's risk-based medical device classification system works, what factors determine a device's class, and why getting it right matters.
sidebar_position: 1
...
**1. Invasiveness**
How far the device enters the body — non-invasive, invasive through a body orifice, surgically invasive (puncturing skin), or implantable.
...
Where the device is intended to be used — peripheral, central circulatory system, central nervous system, heart, etc. Contact with higher-risk anatomical locations results in a higher classification.

**4. Energy source**
Whether the device is active (relies on an energy source other than gravity or the human body) or passive. Active devices have specific classification rules under Schedule 2, Part 2.
...
1. Read the classification rules in Schedule 2 (or Schedule 2A for IVDs)
2. Identify all rules that may apply to your device based on its intended purpose
3. Apply the higher classification where multiple rules apply
4. Document your classification rationale in your technical file
5. Use the TGA's classification guidance documents and decision tools to validate your conclusion

The TGA publishes detailed guidance on classifying both general medical devices and active/software devices:

👉 [Classification of medical devices (not IVDs) — TGA guidance (PDF)](https://www.tga.gov.au/sites/default/files/2024-07/classification-medical-devices-not-ivds-20240702.pdf)
...
👉 [IVD classification guidance — TGA](https://www.tga.gov.au/products/medical-devices/overview/ivd-medical-devices)
...
- [Schedule 2A — Classification rules (IVDs)](https://www.legislation.gov.au/current/F2022C00900)
- [Regulation 3.1–3.3 — MD Regulations 2002](https://www.legislation.gov.au/current/F2022C00900)
- [TGA classification overview](https://www.tga.gov.au/products/medical-devices/overview/medical-devices-overview)
