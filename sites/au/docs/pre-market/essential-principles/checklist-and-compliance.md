...
description: How to document Essential Principles compliance for an Australian medical device application, including the TGA checklist template and what the TGA expects to see.
sidebar_position: 4
...
👉 [Download the Essential Principles Checklist template — TGA](https://www.tga.gov.au/products/medical-devices/manufacturing/quality-safety-and-performance-requirements-medical-devices-essential-principles)
...
1. Identify all applicable standards for the device type
2. Apply the current edition of each standard
3. Document any deviations from standard requirements and justify why compliance with the EP is still achieved
...
- [Essential Principles Checklist — TGA](https://www.tga.gov.au/products/medical-devices/manufacturing/quality-safety-and-performance-requirements-medical-devices-essential-principles)
