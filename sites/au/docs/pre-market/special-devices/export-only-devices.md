...
description: The regulatory pathway for medical devices manufactured in Australia for export only, and the conditions under which a device can be exported without ARTG inclusion.
sidebar_position: 10
...
👉 [Export certificates for medical devices — TGA](https://www.tga.gov.au/products/medical-devices/supply-and-distribution/export-certificates-medical-devices)
...
- [Export-only devices — TGA](https://www.tga.gov.au/products/medical-devices/supply-and-distribution/export-medical-devices)
- [Section 41FN — Therapeutic Goods Act 1989](https://www.legislation.gov.au/current/C2023C00182)
