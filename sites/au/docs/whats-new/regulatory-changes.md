...
description: Significant regulatory changes affecting Australian medical device sponsors and manufacturers in 2024–2025, summarised with links to official TGA sources.
sidebar_position: 1
...
This page summarises significant regulatory changes affecting Australian medical device regulation from 2024 to 2026. Changes are listed from most recent to oldest. For the full legislative history, see [Recent Amendments](/docs/legislation/recent-amendments).
...
Supporting regulations to Part 4-8A of the Therapeutic Goods Act 1989 came into force from **21 March 2025**, commencing a staged implementation of mandatory adverse event reporting by healthcare facilities.

**Implementation timeline:**
- **21 March 2025 – 20 March 2026:** Voluntary reporting period via the new ASDER system
- **21 March 2026:** Mandatory reporting for adverse events involving high-risk devices (Class III, AIMD, IVD Class 4)
- **1 April 2028:** Expanded mandatory reporting for medium-risk devices and near-miss events
- **1 April 2030:** Further expansion

**Who is affected:** All Australian public, private, and day hospitals. Sponsors should update their vigilance processes to account for hospital-initiated reports.

👉 [Healthcare facility reporting — TGA](https://www.tga.gov.au/resources/guidance/reporting-medical-device-adverse-events-healthcare-facilities)
...
👉 [Software and AI — TGA](https://www.tga.gov.au/products/medical-devices/software-and-artificial-intelligence-ai)
...
👉 [Use of overseas regulator evidence — TGA (PDF)](https://www.tga.gov.au/sites/default/files/2024-10/use-market-authorisation-evidence-comparable-overseas-regulators-assessment-bodies-medical-devices-including-ivds.pdf)

---

### July 2024 — Animal, Microbial, and Recombinant Origin Devices

From **1 July 2024**, new classification and conformity assessment requirements apply to medical devices incorporating substances of animal, microbial, or recombinant origin — including collagen-based products, bovine-derived materials, and devices incorporating fermentation-derived substances.

👉 [Animal/microbial/recombinant origin — TGA](https://www.tga.gov.au/resources/guidance/medical-devices-containing-medicinal-microbial-recombinant-or-animal-origin-substances)
