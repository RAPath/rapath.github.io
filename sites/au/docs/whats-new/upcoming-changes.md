...
description: Confirmed and anticipated regulatory changes affecting Australian medical device regulation — what to prepare for and when.
sidebar_position: 3
...
👉 [Medical device regulation changes — TGA](https://www.tga.gov.au/news/news-articles/medical-device-regulation-changes)
...
👉 [Clinical trial pathways](/docs/unapproved-access/clinical-trial-pathways)
...
👉 [UDI rollout — TGA](https://www.tga.gov.au/products/medical-devices/labelling-and-advertising/unique-device-identification-udi-hub)
...
👉 [EU MDR transition guidance — TGA](https://www.tga.gov.au/resources/guidance/eu-mdr-transition-guidance-australian-medical-device-sponsors)
...
🔔 [RAPath AU — upcoming changes issues](https://github.com/RAPath/au/issues?q=label%3Aupcoming-change)
