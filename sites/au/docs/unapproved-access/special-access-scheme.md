---
title: Special Access Scheme (SAS)
description: How the Special Access Scheme allows Australian health practitioners to access medical devices not included in the ARTG for individual patients.
sidebar_position: 1
...
**Key point:** Category A is self-authorising — the practitioner acts first and notifies afterwards. It is reserved for situations where the urgency of the patient's condition means prior TGA approval is not practical.

---

### SAS Category B — Application to TGA required
...
👉 [SAS Category B application — TGA](https://www.tga.gov.au/products/medical-devices/accessing-unapproved-medical-devices/special-access-scheme)

---

### SAS Category C — Authorised supply
...
👉 [SAS Category C — TGA](https://www.tga.gov.au/products/medical-devices/accessing-unapproved-medical-devices/special-access-scheme)

---

## What Can Be Accessed Under SAS
...
SAS does **not** authorise commercial supply — the device cannot be advertised or promoted for the unapproved use.
...
## Reporting Adverse Events Under SAS
