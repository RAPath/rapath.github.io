...
description: Requirements for sponsors to maintain distribution records for medical devices supplied in Australia, to enable effective recalls when required.
sidebar_position: 3
