---
title: Related Instruments & Determinations
description: Legislative instruments, standards orders, and determinations made under the Therapeutic Goods Act 1989 that apply to medical devices in Australia.
sidebar_position: 3
...
👉 [Therapeutic Goods Regulations 1990 — Current text](https://www.legislation.gov.au/current/F1996B00406)
...
This instrument specifies additional articles that are taken to be medical devices for the purposes of the Act, beyond those that meet the primary definition in s41BD. Updated periodically as new device types are identified for regulation.

👉 [Specified Articles Instrument 2020 — legislation.gov.au](https://www.legislation.gov.au/current/F2020L01400)
...
👉 [Therapeutic Goods Orders — TGA](https://www.tga.gov.au/resources/legislation/therapeutic-goods-orders)
...
👉 [GMDN codes — Global Medical Device Nomenclature Agency](https://www.gmdnagency.org)
...
Rules authorising certain health practitioners to supply specified kinds of medical devices (under the SAS Category C pathway) without ARTG inclusion. Updated periodically as new device types are added or removed from the authorised supply list.
...
👉 [UDI — TGA](https://www.tga.gov.au/products/medical-devices/labelling-and-advertising/unique-device-identification-udi-hub)
...
👉 [TGA legislation index](https://www.tga.gov.au/resources/legislation)
