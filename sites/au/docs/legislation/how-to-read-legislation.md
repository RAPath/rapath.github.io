---
title: How to Read Legislation
description: A practical guide to reading and navigating Australian Commonwealth legislation — including the Act, Regulations, and legislative instruments relevant to medical devices.
sidebar_position: 4
...
Australian Commonwealth legislation follows a consistent structure and uses specific drafting conventions. Understanding these conventions makes it much easier to find the provision you need, interpret it correctly, and understand how it relates to other provisions. This page provides a practical introduction for regulatory affairs professionals who regularly work with the Therapeutic Goods Act and MD Regulations.
...
Commonwealth Acts follow this structure:

```
Act Name
├── Chapters (large Acts only — TGA has 8 Chapters)
│   ├── Parts (major subject areas — e.g., Part 4-5)
│   │   ├── Divisions (subdivisions of Parts)
│   │   │   └── Subdivisions (further divisions where needed)
│   ├── Sections (individually numbered — e.g., s41BD)
│   │   ├── Subsections (e.g., s41BD(1))
│   │   │   ├── Paragraphs (e.g., s41BD(1)(a))
│   │   │   └── Subparagraphs
...
## The Relationship Between Acts and Regulations

The Act is the primary legislation — it sets the framework and creates offences and powers. Regulations are subordinate legislation made under the Act's authority:
...
- [Therapeutic Goods legislation](https://www.legislation.gov.au/current/F2002B00237)
