---
title: Exemptions & Waiver of Registration
sidebar_position: 1
description: Devices exempt from NMRA registration and the Waiver of Registration process for research, clinical trials, and donated devices.
---
...
Submit to NMRA:
1. Written application describing the device and its approved exempt purpose
2. Confirmation that the device will NOT be placed on the commercial market or sold
3. Institutional ethics committee approval (for clinical investigation use)
4. Device description and specifications
5. Details of the institution/researcher responsible
...
Add under 'Custom-Made Devices' section, after the definition: 'Ongoing obligations: Although custom-made devices do not require NMRA registration, manufacturers must: (1) maintain device history records and copies of clinician prescriptions for at least 3 years; (2) report any serious adverse events involving the device to NMRA within specified timelines (typically aligned with general medical device vigilance requirements); (3) ensure the device meets applicable essential requirements and relevant standards; (4) apply for Registration Certificate if the same or similar design is subsequently manufactured for a second patient or in series, as this would no longer qualify as custom-made.'
