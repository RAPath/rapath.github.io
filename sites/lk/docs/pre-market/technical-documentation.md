...
sidebar_position: 1
description: Technical documentation requirements for NMRA registration — essential requirements, QMS, risk management, and dossier depth by class.
---

# Technical Documentation

> *NMRA · F-MDR-035 · Essential requirements · ISO 13485 · ISO 14971*
...
| Active devices — energy sources | IEC 60601-1 series |
...
| IIb | Detailed clinical evaluation report; full risk management; MDEC review — prepare for deeper scrutiny |
| III | Comprehensive clinical data; rigorous CER; full design history; MDEC review |

## Local Testing Requirements — LK-Unique
...
|----------------|----------------------|
| Devices that come into **direct contact with the blood stream** | ✅ Yes |
| Latex products — condoms | ✅ Yes |
| Latex products — surgical gloves | ✅ Yes |
| Latex products — examination gloves | ✅ Yes |
| Latex products — bandages with latex content | ✅ Yes |
| Feeding bottles | ✅ Yes |
| Toothbrushes | ✅ Yes |
