...
sidebar_position: 2
description: Clinical evaluation and performance evaluation requirements for NMRA device registration in Sri Lanka.
---

# Clinical Evidence

> *NMRA · CER for general devices · Performance evaluation for IVDs*

## Why Clinical Evidence Is Required

The NMRA requires clinical evidence to establish that a device **performs safely and as intended when used in patients in clinical practice**. Clinical evidence is distinct from bench testing — it addresses the device's actual clinical behaviour, not just its physical or chemical properties.

## General Devices — Clinical Evaluation Report (CER)
...
1. **Define scope** — device description, intended purpose, clinical claims
2. **Identify applicable clinical data** — from three possible sources:
...
3. **Appraise data quality** — assess relevance, methodological quality, and risk of bias
4. **Analyse and conclude** — evaluate whether the data supports the safety and performance claims
5. **Document residual uncertainties** — and how they are addressed (e.g., by PMCF)
