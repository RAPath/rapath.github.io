...
sidebar_position: 4
description: NMRA annual fees, post-approval change management, and MAH licence transfer for registered devices.
---
...
Contact the NMRA Medical Devices Regulatory Division for the current fee schedule and payment process. Fees are typically paid in Sri Lankan Rupees at the prevailing USD rate.

## Post-Approval Change Management

The MAH must notify the NMRA and obtain approval for changes to:

| Change Type | Notification Required |
|------------|----------------------|
| Device design, materials, or specifications | Yes — assess safety impact |
| Intended purpose or indications | Yes — may require re-evaluation |
| Manufacturing process or site | Yes |
| Major labelling changes | Yes |
| New variants or accessories | Yes — may require new registration |
| MAH details | Yes |
...
Registration Certificates have a defined validity period (initially 1–2 years provisional, then renewable). Renew before expiry:

1. Submit renewal application to NMRA
2. Provide updated ISO 13485 certificate (must be current)
3. Confirm no significant changes have occurred (or submit change application first)
...
If the Sri Lanka MAH changes:
1. Submit a MAH transfer application to the NMRA
2. Both outgoing and incoming MAH must cooperate in the transfer
3. Incoming MAH assumes all regulatory obligations from the date of transfer
