---
title: Marketing Authorization Holder (MAH)
sidebar_position: 1
description: Complete guide to the MAH role in Sri Lanka — definition, obligations, scope of accountability, and how to change the MAH.
---

# Marketing Authorization Holder (MAH)

> *LK-Unique · Full cradle-to-grave regulatory accountability*

## What Is an MAH?

The **Marketing Authorization Holder (MAH)** is a Sri Lanka-based entity — company or individual — that is formally responsible to the NMRA for every aspect of a medical device's regulatory status in Sri Lanka. This role has broader accountability than a typical local representative or distributor.

## Scope of MAH Responsibility
...
## Good Distribution Practice (GDP) — LK-Unique

The NMRA has expectations regarding **Good Distribution Practice of Medical Devices (GDPMD)** — standards for how registered devices are stored, transported, and distributed. The MAH is responsible for ensuring distribution activities comply with GDPMD requirements.
...
## Price Regulation — LK-Unique NMRA USD Rate Schedule
