---
title: Reliance Pathway
sidebar_position: 2
description: NMRA reliance pathway for faster device registration — eligible classes, accepted reference countries, documentation requirements.
---
...
Add a new subsection after 'Accepted Reference Countries': 'Non-Accepted Reference Countries: If your device holds approval from a regulatory authority not listed above (e.g., South Korea MFDS, India CDSCO, Brazil ANVISA), you cannot use the reliance pathway. The device must proceed through full NMRA review (Full Registration route) regardless of approvals held elsewhere. Contact NMRA Medical Devices Regulatory Division if your reference country is not listed to confirm eligibility or inquire about potential future expansion of the reliance pathway.'
