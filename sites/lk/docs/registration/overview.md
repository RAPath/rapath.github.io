...
sidebar_position: 1
description: NMRA device registration — two-step process overview, MAH appointment, consolidated dossier, MDEC review, reliance pathway.
---
...
See [Foreign Facility Registration](/registration/foreign-facility) for details.
...
|-------|-------|---------------------|
| Reliance | I / IIa | 2–4 months |
| Reliance | IIb | 3–5 months (MDEC) |
