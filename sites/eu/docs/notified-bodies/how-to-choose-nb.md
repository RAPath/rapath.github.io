---
id: how-to-choose-nb
title: How to choose a notified body
sidebar_label: How to choose a notified body
sidebar_position: 2
...
1. Notify the MDCG of the application (via EUDAMED)
2. Submit the **clinical evaluation assessment report** to an **expert panel** for scientific opinion
3. Wait up to 60 days for the opinion
4. Take the opinion into account in its certification decision
5. Document any departure from the expert panel's opinion with justification
