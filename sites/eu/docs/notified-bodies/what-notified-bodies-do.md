---
id: what-notified-bodies-do
title: What notified bodies do
sidebar_label: What notified bodies do
sidebar_position: 1
tags: [notified-bodies, conformity-assessment]
---
...
- They do **not** approve or reject devices on safety grounds independently of the manufacturer — their role is to assess whether the manufacturer has demonstrated compliance
- They do **not** replace the manufacturer's own technical and clinical assessment — they review it
- They are **not responsible** for the safety of devices they certify — that responsibility remains with the manufacturer
- They do **not** conduct post-market surveillance of devices — that is the manufacturer's obligation

---

## The NANDO database

The **NANDO database** (New Approach Notified and Designated Organisations) is the official EU register of all designated notified bodies. It lists:
- Each NB's name, country, and identification number
- The regulations and annexes under which each NB is designated
- The scope of designation — device types and categories each NB is authorised to assess

All EU notified bodies must be in NANDO to be legally authorised to issue MDR/IVDR certificates. A certificate from a body not listed in NANDO is not valid.

**URL**: ec.europa.eu/growth/tools-databases/nando

---

## Related pages

- [How to choose a notified body](./how-to-choose-nb)
...
| MDR Annex VII | NB designation requirements |
| MDR Art. 93 | Unannounced audits |
| MDR Art. 54 | Expert panel consultation |
| IVDR Art. 33–47 | IVDR NB framework |
