...
sidebar_position: 1
tags: [mdr, ivdr, non-eu, international, eu-rep]
---
...
Using FDA clinical data in an EU clinical evaluation is generally acceptable (see [Using international clinical data](/pre-market/clinical-evidence/using-international-clinical-data)), but FDA 510(k) clearance itself does not satisfy MDR conformity assessment requirements.
...
- [Who needs to comply — EU REPs](/start-here/who-needs-to-comply/authorised-representatives)
- [Using international clinical data](/pre-market/clinical-evidence/using-international-clinical-data)
