...
sidebar_label: What must be reported
sidebar_position: 1
tags: [mdr, ivdr, vigilance, adverse-events, serious-incidents]
---
...
1. **Serious incidents** — adverse events involving a marketed device that meet defined criteria
2. **Field safety corrective actions (FSCAs)** — actions taken by manufacturers to reduce risk from a device already on the market
