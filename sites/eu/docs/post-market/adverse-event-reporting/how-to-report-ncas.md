---
id: how-to-report-ncas
title: How to report — national competent authorities
sidebar_label: How to report (NCAs)
sidebar_position: 4
tags: [mdr, ivdr, vigilance, reporting, nca]
---
...
For serious incidents — Report to the NCA of each member state where the incident occurred. If it is unclear which member state(s) are affected or if the incident's location cannot be determined, report to the NCA of the member state where the device is predominantly marketed or where the manufacturer's EU REP is based, and clearly document the uncertainty in the report. The receiving NCA may redistribute the report to other affected member states as appropriate.
