---
id: when-fsca-required
title: When an FSCA is required
sidebar_label: When an FSCA is required
sidebar_position: 1
tags: [mdr, ivdr, fsca, field-safety, recall]
---
...
4. **Notify NCAs**: before implementation where possible (see [Reporting timeframes](/post-market/adverse-event-reporting/reporting-timeframes))
