---
id: recalls-classification-coordination
title: Recalls — classification & coordination
sidebar_label: Recalls — classification & coordination
sidebar_position: 3
tags: [mdr, ivdr, recall, fsca, field-safety]
---
...
1. **NCA notification**: the manufacturer notifies each NCA in the affected member states simultaneously via EUDAMED
2. **FSN translation**: FSNs must be translated into the official language(s) of each affected member state
3. **Distributor chain notification**: distributors and importers in each country must be notified and required to pass the FSN to their customers
4. **Cross-NCA coordination**: NCAs may communicate through EUDAMED or directly to coordinate their oversight of the FSCA
