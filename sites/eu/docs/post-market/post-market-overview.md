---
id: post-market-overview
title: Overview & ongoing obligations
sidebar_label: Overview & ongoing obligations
sidebar_position: 1
tags: [mdr, ivdr, post-market, fundamentals]
---
...
|---|---|---|
| **Post-market surveillance** | Proactively collect and analyse data on device performance | [PMS](/post-market/post-market-surveillance/pms-requirements) |
| **Vigilance** | Report serious incidents and field safety corrective actions | [Adverse event reporting](/post-market/adverse-event-reporting/what-must-be-reported) |
| **Field safety** | Implement corrective actions where devices pose unacceptable risk | [FSCAs](/post-market/field-safety-corrective-actions/when-fsca-required) |
| **EUDAMED** | Register and maintain device and operator information | [EUDAMED](/post-market/eudamed-registration/overview) |
| **Labelling** | Maintain compliant labelling and advertising | [Labelling](/post-market/labelling-advertising/labelling-requirements) |
...
See [Adverse event reporting](/post-market/adverse-event-reporting/what-must-be-reported) for full detail.
