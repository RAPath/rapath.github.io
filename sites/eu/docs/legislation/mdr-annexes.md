---
id: mdr-annexes
title: MDR Annexes — all 17
sidebar_label: MDR Annexes
sidebar_position: 3
tags: [mdr, legislation, annexes]
---
...
→ See [GSPR overview](/pre-market/gspr/gspr-overview)
...
→ See [Technical documentation overview](/pre-market/technical-documentation/technical-documentation-overview)
...
→ See [Post-market data in technical documentation](/pre-market/technical-documentation/post-market-data-in-tech-doc)
...
→ See [EU Declaration of Conformity](/pre-market/conformity-assessment/eu-declaration-of-conformity)
...
→ See [EUDAMED device registration](/post-market/eudamed-registration/device-registration-udi)
...
→ See [What notified bodies do](/notified-bodies/what-notified-bodies-do)
...
→ See [Classification rules 1–22](/pre-market/classification/mdr-classification-rules)
...
→ See [Annex IX — QMS + Tech Doc](/pre-market/conformity-assessment/annex-ix-qms-tech-doc)
...
→ See [Annex X — Type examination](/pre-market/conformity-assessment/annex-x-type-examination)
...
→ See [Custom-made devices](/pre-market/special-device-types/custom-made-devices)
...
→ See [Clinical evaluation overview](/pre-market/clinical-evidence/clinical-evaluation-overview)
...
→ See [Clinical investigations](/pre-market/clinical-evidence/clinical-investigations)
...
→ See [What is a medical device?](/start-here/what-is-a-medical-device)
...
|---|---|
| MDR 2017/745, Annexes I–XVII | Full annex texts |
