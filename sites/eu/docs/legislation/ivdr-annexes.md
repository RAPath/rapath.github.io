---
id: ivdr-annexes
title: IVDR Annexes — all 16
sidebar_label: IVDR Annexes
sidebar_position: 4
tags: [ivdr, legislation, annexes]
---
...
→ See [IVDR classification rules 1–7](/pre-market/classification/ivd-classification-rules)
...
→ See [Conformity assessment overview](/pre-market/conformity-assessment/conformity-assessment-overview)
...
→ See [Performance evaluation](/pre-market/clinical-evidence/performance-evaluation)
...
→ See [Performance studies](/pre-market/clinical-evidence/performance-studies)
