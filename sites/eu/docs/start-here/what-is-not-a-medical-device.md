---
id: what-is-not-a-medical-device
title: What is not a medical device?
sidebar_label: What is not a medical device?
sidebar_position: 3
tags: [mdr, ivdr, definition, borderline, fundamentals]
---
...
1. **Explicit exclusions** in the regulations themselves (Art. 1(5)–(6) MDR; Art. 1(4)–(5) IVDR)
2. **Definitional non-qualification** — the product simply does not meet the conditions of the Article 2 definition
...
1. Draft the intended purpose statement carefully
2. Consult the MDCG borderline guidance
3. Consider seeking a formal opinion from the relevant national competent authority
:::
