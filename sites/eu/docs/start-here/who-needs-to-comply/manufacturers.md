...
sidebar_position: 1
tags: [mdr, ivdr, manufacturer, economic-operators]
---
...
|---|---|
| Original equipment manufacturer (OEM) who designs and builds the device | ✅ Manufacturer |
| Brand-owner who contracts a CMO to build and sells under own label | ✅ Manufacturer |
| Contract manufacturer building under another company's label | ❌ Not the manufacturer (the brand-owner is) |
| Healthcare institution that builds an in-house device for own use | ✅ Manufacturer (limited exemption may apply — MDR Art. 5(5)) |
| Distributor who repackages or relabels a device | ✅ Becomes a manufacturer |
| Company that fully refurbishes a single-use device | ✅ Becomes a manufacturer |

---

## Where must the manufacturer be established?
...
- **Non-EU manufacturers** must designate an **EU Authorised Representative (EU REP)** before placing a device on the EU market — there are no exceptions

---

## Core obligations under MDR/IVDR Article 10
...
- Register the device and relevant data in **EUDAMED** (Art. 29–30 MDR)
- Apply a **Unique Device Identifier (UDI)** to the device and its packaging (MDR Art. 27 / IVDR Art. 24)

### Labelling

- Ensure the device bears labelling that meets MDR Annex I §23 / IVDR Annex I §20 requirements
...
- Establish a **post-market surveillance (PMS) system** proportionate to the risk class (MDR Art. 83–86 / IVDR Art. 78–82)
...
- Report **serious incidents** and carry out **field safety corrective actions (FSCA)** as required by the vigilance system (MDR Art. 87–92 / IVDR Art. 82–87)
...
2. Identification of applicable general safety and performance requirements
3. Responsibility of management
4. Resource management (including supplier and subcontractor management)
5. Risk management
6. Clinical evaluation / performance evaluation and PMCF / PMPF
7. Product realisation (design, manufacture, etc.)
8. UDI assignment
9. Setting up, implementation, and maintenance of the PMS system
10. Communication with competent authorities, notified bodies, and economic operators
11. Handling of corrective and preventive actions (CAPA) and non-conformities
12. Monitoring and measurement of outputs, data analysis, and product improvement
...
## Manufacturer liability and legal responsibility
...
| MDR Art. 29–30 | EUDAMED registration |
