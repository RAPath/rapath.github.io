...
sidebar_label: Person responsible for regulatory compliance
sidebar_position: 5
tags: [mdr, ivdr, prrc, economic-operators]
---
...
1. The **conformity of devices** is appropriately checked before release (including applicable conformity assessment procedures, DoC, and CE marking)
2. The **technical documentation and EU DoC are drawn up** and kept up to date
3. **Post-market surveillance obligations** are fulfilled (including PSUR/PMS reports, PMCF/PMPF, vigilance reporting)
4. **Reporting obligations** are complied with — serious incident reports, trend reports, FSCAs
5. For **investigational devices**: the applicable requirements are met before clinical investigations or performance studies begin
6. Any statement made in communications to competent authorities, notified bodies, or other parties on behalf of the manufacturer or EU REP is **accurate and not misleading**
