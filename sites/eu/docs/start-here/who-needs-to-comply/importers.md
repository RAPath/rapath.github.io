...
sidebar_position: 3
tags: [mdr, ivdr, importer, economic-operators]
---
...
| | EU REP | Importer |
|---|---|---|
| Function | Legal representative of non-EU manufacturer | First entity to place the device on the EU market |
...
| Can be same entity? | Yes — one company can act as both EU REP and importer | Yes |
...
|---|---|
| Verify CE marking, DoC, UDI, EU REP before import | Art. 13(2) |
| Ensure storage/transport conditions | Art. 13(4) |
| Register in EUDAMED (SRN) | Art. 30 |
| Affix importer name/address to device | Art. 13(3) |
| Maintain records of complaints and FSCAs | Art. 13(5) |
| Cooperate with competent authorities | Art. 13(6)–(7) |
| Not supply non-compliant devices | Art. 13(8) |
