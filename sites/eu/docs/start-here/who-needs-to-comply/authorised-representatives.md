---
id: authorised-representatives
title: Authorised representatives (EU REPs)
sidebar_label: Authorised representatives (EU REPs)
sidebar_position: 2
tags: [mdr, ivdr, eu-rep, economic-operators]
---
...
|---|---|---|
| Accept written mandate from non-EU manufacturer | Art. 11(1) | Art. 11(1) |
| Register in EUDAMED | Art. 30 | Art. 27 |
| Keep Technical Documentation and DoC available | Art. 11(3)(b) | Art. 11(3)(b) |
| Cooperate with competent authorities | Art. 11(3)(e) | Art. 11(3)(e) |
| Respond to requests from competent authorities | Art. 11(3)(f) | Art. 11(3)(f) |
| Terminate mandate if manufacturer is non-compliant | Art. 11(4) | Art. 11(4) |
| Display name/address on device labelling | Art. 11(2) | Art. 11(2) |
...
| MDR Art. 11 | Obligations of authorised representatives |
| IVDR Art. 2(29) | Definition of authorised representative (IVDR) |
| IVDR Art. 11 | Obligations of authorised representatives (IVDR) |
| MDCG 2021-17 | Guidance on the role of economic operators |

Complete the section with: 'Who can be an EU REP?: Any natural person (individual) or legal person (company) established within an EU member state can be appointed as an EU REP. There is no requirement for the EU REP to be an expert in the device category—however, the EU REP must have sufficient understanding of the manufacturer's QMS, technical documentation, and conformity assessment pathway to verify compliance and communicate meaningfully with competent authorities. In practice, many EU REPs are specialist service providers, legal entities, or consultancies with medical device expertise. A single EU REP can represent multiple non-EU manufacturers, provided the mandate and EUDAMED registration clearly specify which device(s) each EU REP is responsible for. The PRRC (Person Responsible for Regulatory Compliance) within the EU REP organisation must hold relevant qualifications and experience.'
