---
id: annex-ix-qms-tech-doc
title: Annex IX — QMS + Technical Documentation Assessment
sidebar_label: Annex IX — QMS + Tech Doc
sidebar_position: 2
tags: [mdr, ivdr, conformity-assessment, annex-ix, qms]
---
...
1. **The manufacturer's Quality Management System (QMS)** — ensuring processes are in place to consistently design, manufacture, and control devices
2. **Technical documentation** — evidence that the specific device meets all applicable requirements
...
1. **Document review**: QMS documentation, procedures, and records
2. **On-site audit**: inspection of manufacturing and other sites; interviews with key personnel; review of design and production records
3. **Audit report**: findings, non-conformities, and corrective action requests
4. **Certificate decision**: QMS certificate issued (or refused) based on audit outcomes
...
1. The NB assesses the clinical evaluation report and notifies an expert panel
2. The expert panel reviews the clinical evaluation and issues a scientific opinion within 60 days
3. The NB takes the opinion into account and must document any departure from it with justification
4. Only then can the NB issue or renew the certificate
...
- [Scrutiny procedure (Art. 54)](/notified-bodies/scrutiny-procedure)
