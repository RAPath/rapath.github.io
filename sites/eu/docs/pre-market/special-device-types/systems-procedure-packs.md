---
id: systems-procedure-packs
title: Systems & procedure packs
sidebar_label: Systems & procedure packs
sidebar_position: 11
tags: [mdr, special-device-types, systems, procedure-packs]
---
...
|---|---|
| MDR Art. 22 | Systems and procedure packs |
...
The assembler does not: Create a new CE-marked product by combining components; Assume responsibility for the safety or performance of individual component devices; Modify, remanufacture, or alter the original devices (beyond physical combination and compatible packaging); Become responsible for non-CE-marked products included in the system; Re-certify components or reassess their original classification; Incur liability for defects in the original component devices themselves (only for the act of combining).
