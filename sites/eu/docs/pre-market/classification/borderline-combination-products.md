---
id: borderline-combination-products
title: Borderline & combination products
sidebar_label: Borderline & combination products
sidebar_position: 7
tags: [mdr, ivdr, classification, borderline]
---
...
The MDR/IVDR split is covered fully in [MDR vs IVDR — which applies?](/start-here/mdr-vs-ivdr). The main borderline:
...
1. **Compile a product dossier** — intended purpose, mechanism of action, relevant claims, composition
2. **Contact the relevant NCA** — in the member state where you intend to first place the product
3. **Request a formal opinion** — most NCAs offer a borderline query process; timelines vary (weeks to months)
4. **For drug-device combinations**: consider pre-submission meetings with both EMA (for the drug aspect) and a notified body (for the device aspect)
