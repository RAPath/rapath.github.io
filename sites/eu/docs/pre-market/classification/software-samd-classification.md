...
Before classifying software, establish that it **qualifies as a medical device** under MDR Art. 2(1) or as an IVD under IVDR Art. 2(2). Software qualifies only if it:
