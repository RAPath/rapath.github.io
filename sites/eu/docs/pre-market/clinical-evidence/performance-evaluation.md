...
title: Performance evaluation (Annex XIII)
sidebar_label: Performance evaluation (IVDR)
sidebar_position: 5
tags: [ivdr, clinical-evidence, performance-evaluation, annex-xiii]
---
...
Stage 2 — Analytical performance studies: Conduct laboratory studies to establish analytical sensitivity (LoD, LoQ), analytical specificity (freedom from cross-reactivity and interference), accuracy/trueness, precision (within-run and between-run reproducibility), linearity, measuring range, and stability. Stage 3 — Clinical performance studies: Where clinically relevant, conduct analytical studies using specimens from human subjects to establish diagnostic sensitivity, diagnostic specificity, positive and negative predictive values, and clinical concordance with established reference methods or gold standard. Stage 4 — Appraisal of available data: Critically review all existing data from published literature, clinical studies, post-market surveillance, and registry data for relevance and scientific validity. Stage 5 — Analysis and conclusions: Synthesise all data to demonstrate that the IVD achieves its intended analytical and clinical performance across the intended use population and use environment. Stage 6 — Post-market performance follow-up plan reference: Reference the PMPF plan and justify its adequacy for ongoing surveillance and data collection.
