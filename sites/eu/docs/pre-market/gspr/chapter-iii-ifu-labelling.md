---
id: chapter-iii-ifu-labelling
title: Chapter III — IFU & labelling
sidebar_label: Chapter III · IFU & labelling
sidebar_position: 4
tags: [mdr, ivdr, gspr, annex-i, labelling, ifu]
---

# GSPR Chapter III — Information supplied with the device

:::note Regulatory basis
**MDR 2017/745, Annex I, Chapter III, Section 23** and **IVDR 2017/746, Annex I, Chapter III, Section 20**. These are the labelling and IFU requirements as part of the GSPR. Post-market labelling obligations are covered separately in [Labelling & advertising](/post-market/labelling-advertising/labelling-requirements).
:::
...
## What Chapter III requires

Chapter III of Annex I establishes the requirements for information supplied with devices, including:
- **Labels** — information on or attached to the device or its packaging
- **Instructions for use (IFU)** — directions for safe and effective use
- **Symbols** — standardised graphical symbols used in labelling
...
## Section 23 — MDR labelling requirements
...
| Expiry date | If applicable — express as YYYY-MM-DD or YYYY-MM |
| "Sterile" designation | If device is sterile — standardised symbol |
...
| Importer information | Where applicable — name and address |
...
### Labels for IVDs (IVDR Annex I Section 20.2)
...
## Section 23 — MDR IFU requirements
...
1. Name, trade name, or trademark of the device
2. Intended purpose (in detail)
3. Device description and accessories
4. Indications, contraindications, warnings, and precautions
5. Instructions for use in each step — preparation, set-up, use, cleaning, disinfection, sterilisation (if reusable), disposal
6. Residual risks, side effects, and undesirable effects
7. Conditions for storage and handling
8. Instructions for any required maintenance, repair, and calibration
9. Information on any medicinal substance incorporated
10. Electromagnetic compatibility information
11. Cybersecurity information (for networked devices)
12. Performance characteristics and limitations
13. For implantable devices: information to be given to the patient
14. Contact details for the manufacturer
15. Date of issuance or last revision of IFU
16. Legal manufacturer's notice for warnings or precautions

### IVDR-specific IFU requirements
...
## When IFU may be omitted

For certain **Class I and IIa** devices, an IFU may be **omitted** if the device is intended for use by professional users and can be used safely without one. The label alone must then contain sufficient information. This is an exception — the default is that an IFU is required.
...
- Be standardised — ideally from **EN ISO 15223-1** (Symbols to be used with information to be supplied by the manufacturer)
...
| SN | Serial number |
| ∑ | Total number of units in packaging |
| ▶ | Consult instructions for use |
| i | Consult instructions for use (electronic) |
| 🌡 | Temperature limit (with range) |
