...
sidebar_position: 1
description: The Medical Device Establishment Licence (MDEL) — who needs one, what it covers, and how to apply.
---
...
MDEL holders must: Notify Health Canada in writing within 30 days of any material changes to the establishment, regulated activities, or device types listed on the licence; Pay annual MDEL fees by the due date specified on the invoice; Maintain distribution records for the period specified in the Medical Devices Regulations (minimum 2 years after distribution or the device's expected lifetime, whichever is longer); Report mandatory problems (adverse events, complaints indicating a risk to health) to Health Canada within required timeframes; Cooperate fully with Health Canada inspections, including providing access to facilities, records, and personnel.
