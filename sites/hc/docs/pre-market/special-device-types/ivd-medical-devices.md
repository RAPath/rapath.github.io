...
sidebar_position: 1
description: Regulatory requirements for in vitro diagnostic (IVD) medical devices in Canada.
---
# IVD Medical Devices
...
See also: [IVD Classification Rules](/pre-market/classification/ivd-classification-rules)
