---
title: Using Overseas Clinical Data
sidebar_position: 3
description: How to use clinical data from other jurisdictions (US, EU, Australia) in a Health Canada Device Licence application.
---
...
ANVISA approval
Generally accepted
Canada (U.S.-Canada reciprocity)
FDA approval + additional evidence
May be accepted with bridging data
...
1. Clinical Evidence Summary — synthesising the evidence from all sources
2. Study reports — complete study reports for pivotal studies
3. Published literature — peer-reviewed publications where study reports are not available
4. Regulatory approvals — copies of approval letters/decisions from other jurisdictions (helps establish that the data was previously accepted by a comparable regulator)
