...
sidebar_position: 3
description: Risk management requirements for Health Canada Device Licence applications, including ISO 14971 application and documentation expectations.
---
...
Class I device manufacturers — While Class I devices do not require a Device Licence application, manufacturers must still conduct and document risk management in accordance with ISO 14971:2019. The risk management file must be maintained internally and made available during Health Canada inspections. This documentation is essential for post-market surveillance, recall management, and defending compliance if a device-related incident occurs.

Add after the 'Risk management report' section: 'Risk Management File — The complete risk management file (RMF) is a compilation of all risk management activities and should be organized to include: the risk management plan, hazard analysis worksheets, risk estimation tables, risk evaluation records, risk control measures and their justification, residual risk evaluations, and the risk management report. For Class III and IV devices, Health Canada may request the full RMF during the review process or upon inspection.'
