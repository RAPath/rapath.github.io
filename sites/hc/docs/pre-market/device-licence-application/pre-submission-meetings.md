---
title: Pre-Submission Meetings
sidebar_position: 6
description: Health Canada's Pre-Submission Meeting (PSM) program for medical device manufacturers seeking guidance before filing a Device Licence application.
---
...
5. Health Canada provides written guidance based on the meeting discussion within 15–20 business days of the meeting date. Manufacturers proceed with application development informed by this guidance, with the option to request a follow-up meeting if further clarification is needed.
...
> **Official resource:** [Health Canada — Pre-submission meetings](https://www.canada.ca/en/health-canada/services/drugs-health-products/medical-devices/application-information/guidance-documents.html)
