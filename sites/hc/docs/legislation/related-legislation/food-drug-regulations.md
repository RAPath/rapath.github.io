...
sidebar_position: 2
description: The Food and Drug Regulations and their relevance to medical device-drug combination products in Canada.
---
...
1. **Combination products** where the drug or biologic is the primary mode of action — in these cases, the Food and Drug Regulations (not the MDR) govern the regulatory pathway
2. **Drug components** of integral drug-device combination products
3. **Sterile manufacturing** — some provisions of the Food and Drug Regulations (particularly Part C, Division 2, Schedule F) set standards that are cross-referenced in device guidance
