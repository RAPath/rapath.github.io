---
title: Bilingual Requirements (English & French)
sidebar_position: 2
description: Canada's bilingual labelling requirements for medical devices — English and French requirements under the Official Languages Act.
---
...
1. Develop bilingual labels from the outset rather than translating English-only labels
2. Use professional translation by translators familiar with medical/regulatory terminology
3. Have translations reviewed by a Canadian French-speaking regulatory professional
4. Note that Québec French differs from international French — terminology should be appropriate for Canadian usage
