...
sidebar_position: 1
description: What must be reported to Medsafe, reporting timeframes, how to submit a report, and exemptions from reporting obligations in New Zealand.
---
...
- Medsafe may also have a web form — check [medsafe.govt.nz](https://www.medsafe.govt.nz) for the current submission method
