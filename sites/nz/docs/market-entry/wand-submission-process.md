---
title: WAND submission process
sidebar_position: 3
description: Step-by-step guide to notifying a medical device to the WAND database — information required, the GMDN code, the 30-day timeline, and the statutory declaration.
---
...
| Information | Detail |
|---|---|
| Device name and model | As described by the manufacturer |
| GMDN code | Global Medical Device Nomenclature code — see below |
| Risk classification | The correct class under Schedule 2 (Class I, IIa, IIb, III, or AIMD) |
| Manufacturer name and address | Registered office or principal place of business |
| Manufacturer contact | Phone or email |
| Sponsor name and address | Registered office or principal place of business in New Zealand |
| Sponsor contact | Phone or email |
...
A **GMDN code** is a mandatory part of WAND notification. The GMDN is an internationally recognised system of generic names and codes for medical devices managed by the [GMDN Agency](https://www.gmdnagency.org).
