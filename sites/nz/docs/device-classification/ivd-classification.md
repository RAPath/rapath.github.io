...
sidebar_position: 3
description: How in vitro diagnostic devices are classified in New Zealand — the four IVD classes, classification rules, and the key difference from non-IVD regulation (IVDs are WAND-exempt).
---
