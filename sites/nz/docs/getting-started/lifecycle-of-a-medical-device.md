---
title: Lifecycle of a medical device in NZ
sidebar_position: 6
description: A step-by-step overview of the regulatory lifecycle for a medical device in New Zealand — from pre-market through to recall or retirement.
---
...
Notification is not approval — Medsafe does not assess the submission before issuing WAND confirmation. Supply can begin once the WAND notification is complete and the Sponsor has confirmed that all conformity evidence is held and ready for inspection.
