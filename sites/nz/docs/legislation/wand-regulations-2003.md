---
title: WAND Regulations 2003
sidebar_position: 2
description: The Medicines (Database of Medical Devices) Regulations 2003 — the instrument that establishes WAND, the 22 classification rules (Schedule 2), and exempt devices (Schedule 1).
---
...
The Regulations were made under the Medicines Act 1981. They are available in full at [legislation.govt.nz](https://www.legislation.govt.nz/regulation/public/2003/0352/latest/whole.html).
...
See [Exempt Devices](/market-entry/exempt-devices) for a full explanation of Schedule 1 categories.
...
Remove the instruction: "Expand 'Regulation 7 — Updates' section with: 'Changes must be notified to Medsafe within 10 working days. Updates are typically submitted via the WAND portal by logging into the Sponsor account and modifying the relevant entry. If the portal cannot be accessed or the nature of the change is complex, Sponsors should contact Medsafe directly with full details of the device and the change required.'" and either integrate this guidance into the actual Regulation 7 section or remove it entirely.
