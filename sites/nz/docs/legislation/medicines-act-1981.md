...
sidebar_position: 1
description: Overview of the Medicines Act 1981 — New Zealand's primary legislation for medical devices — key provisions, Medsafe's powers, and offences.
---
...
| Section | Content |
|---|---|
| Section 2 | Definitions — including the definition of "medical device" |
| Part 2 | Offences — including offences relating to supply of unsafe or non-compliant devices |
| Part 4 | Licensing — GMP licensing of manufacturers (for medicines; some device manufacturers) |
| Part 6 | General regulatory powers — Medsafe's powers of inspection and information gathering |

The Act is available in full at [legislation.govt.nz](https://www.legislation.govt.nz/act/public/1981/0118/latest/whole.html).
...
These gaps are a primary driver of the **Medical Products Bill** currently being developed to replace it. See [Medical Products Bill](/legislation/medical-products-bill).
