...
Complaints must be evaluated and investigated within a defined timeframe (typically within 10 business days of receipt). If a complaint meets adverse event reporting criteria, it must be reported to MHLW within the applicable reporting window (typically 30 days from the date the MAH becomes aware of the event, depending on the severity and urgency classification assigned by the MAH).
