---
title: Domestic Manufacturing Licence (Seizou Gyosha)
sidebar_position: 10
---

# Domestic Manufacturing Licence (Seizou Gyosha)
...
**Full manufacturing licence (製造業許可 — seizō gyō kyoka)**
Required for manufacturing facilities that:
...
**Manufacturing registration (製造業登録 — seizō gyō tōroku)**
A lighter registration (rather than full licence) for facilities conducting:
