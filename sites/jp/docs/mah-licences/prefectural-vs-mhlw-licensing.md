---
title: Prefectural vs MHLW Licensing Authority
sidebar_position: 14
---
...
The Tokyo Metropolitan Government Health and Welfare Bureau (東京都福祉保健局) is the licensing authority. Note that Japan's prefectural government structures are subject to administrative reorganizations; verify the current bureau responsible for medical device licensing with the Tokyo Metropolitan Government website. is the most frequently encountered prefectural licensing authority in the medical device industry, given Tokyo's concentration of MAHs and device manufacturers. Their processes and timelines are broadly similar to other prefectures but may have Tokyo-specific administrative practices.
...
Device classification: To determine which authority to contact, you must first establish your device's regulatory class (I, II, III, or IV). Device class is determined by MHLW based on risk and intended use — it is not a choice. If you are unsure of your device's class, consult with MHLW's Policy-Evaluating Division (医療機器審査第一部 or relevant section) before applying for an MAH licence. Applying for a General MAH licence when a Class IV MAH licence is required will result in rejection.
