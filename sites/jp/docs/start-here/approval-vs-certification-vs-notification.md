---
title: Approval vs Certification vs Notification
sidebar_position: 8
---
...
1. **Classify the device** — determine the JMDN code and class (I–IV)
2. **Check the recognised standards list** — does an MHLW-recognised standard exist for this device type?
   - If Class I → Todokede
...
Borderline situations (such as a Class II device where an RCB determines it does not conform to the available recognised standard) require case-by-case evaluation with PMDA.
