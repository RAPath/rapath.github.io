...
FMR is applied for by the Japan-based MAH on behalf of the overseas manufacturer. The overseas manufacturer submits supporting documentation (facility information, QMS evidence) but does not submit the application directly to MHLW; all communication flows through the MAH.
...
1. Appoint a Japan-based MAH (subsidiary or third-party service company)
2. Apply for FMR through the MAH as part of the Shonin/Ninsho application process
3. Prepare their QMS documentation to demonstrate MO 169 compliance. Many overseas manufacturers leverage their existing ISO 13485 certification as a foundation, but MO 169 contains Japan-specific requirements that must be explicitly addressed.
