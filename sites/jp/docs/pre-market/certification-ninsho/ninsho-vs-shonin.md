---
title: When to Switch from Ninsho to Shonin
sidebar_position: 5
---
...
1. Confirm with PMDA (via pre-submission consultation) that Shonin is required and what data package PMDA expects
2. Prepare the Shonin dossier — this will typically require more data than the original Ninsho application (particularly for clinical evidence and manufacturing details)
3. Submit the Shonin application to PMDA
...
The transition period requires careful management to avoid market access gaps. MAHs should coordinate with PMDA about the timing of Ninsho cancellation relative to Shonin approval issuance to ensure continuous market authorization.
