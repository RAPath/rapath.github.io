...
- Operating principle — how the device achieves its intended effect
- Intended use statement (Japanese language) — this will become the approved indication on the Shonin
- Contraindications
