...
Adverse events (AEs) are unintended harmful occurrences associated with device use, including:
...
**Reporting Channel**
All adverse event reports must be submitted via the SUGAM portal or directly to CDSCO Pharmacovigilance Division.
