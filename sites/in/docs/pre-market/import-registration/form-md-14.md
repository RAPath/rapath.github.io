---
sidebar_position: 2
title: Form MD-14 — Import Licence (Class B / C / D)
description: Detailed guide to obtaining an import licence (Form MD-14) for Class B, C, and D medical devices in India via CDSCO and the SUGAM portal.
keywords: [Form MD-14, import licence, India, CDSCO, SUGAM, Class B C D]
---
...
1. **Create SUGAM account** — register the IAR and foreign manufacturer on [sugam.cdsco.gov.in](https://sugam.cdsco.gov.in);
...
Add after 'Conditions of licence' section: 'Deficiency management: If CDSCO issues a deficiency letter during review, the applicant must respond within the specified deadline (typically 30 days, extendable on written request). Failure to respond may result in rejection. Rejected applications do not preserve review timeline progress — a fresh application with a new fee must be submitted. Multiple deficiency rounds can extend the total timeline by 30–90 days per round. CDSCO may also issue a 'provisional rejection' if the submitted data is deemed insufficient; provisional rejection allows for one round of resubmission with corrective data.'
