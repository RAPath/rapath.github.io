---
sidebar_position: 6
title: SUGAM Portal — Submission Process
description: Step-by-step guide to submitting a medical device import licence application on the CDSCO SUGAM portal.
keywords: [SUGAM, India, CDSCO, online submission, import licence, medical device portal]
---
...
- Register your IAR organisation on SUGAM;
- Register the foreign manufacturer on SUGAM;
- Prepare all documents in acceptable formats (PDF, size limits apply);
- Confirm the applicable form (MD-14 for Class B/C/D; MD-15 for Class A).
