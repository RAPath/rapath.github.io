...
description: An overview of Singapore's risk-based medical device classification system — Classes A, B, C, and D — and how HSA's classification rules apply.
---
...
Singapore uses a **four-class, risk-based classification system** for medical devices, defined in the [Health Products (Medical Devices) Regulations 2010](../../legislation/hp-md-regulations.md). The four classes are A (lowest risk), B (low-to-medium risk), C (medium-to-high risk), and D (highest risk).
...
- **Risk classification rules and factors**: [hsa.gov.sg/medical-devices/registration/risk-classification-rule](https://www.hsa.gov.sg/medical-devices/registration/risk-classification-rule)
- **Risk classification tool** (interactive): [hsa.gov.sg/medical-devices/registration/risk-classification](https://www.hsa.gov.sg/medical-devices/registration/risk-classification)
...
In vitro diagnostic medical devices follow a **separate set of classification rules** also set out in the HP(MD) Regulations. IVDs are classified based on the intended use, the analyte or parameter detected, and the consequences of an incorrect result. See [IVD Classification](./ivd-classification.md).
...
- Which [evaluation route](../registration/evaluation-routes.md) applies (and therefore what documentation is required and what the turnaround time will be);
- Which [registration guides](https://www.hsa.gov.sg/medical-devices/registration/guides) apply;
