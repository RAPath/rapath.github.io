...
description: How in vitro diagnostic medical devices (IVDs) are classified under Singapore's HP(MD) Regulations 2010, including Class A through D IVD rules and examples.
---
...
Notably, the EDR route exclusions for high-risk IVDs apply specifically to **IVD assays** for HIV testing and blood/tissue donor compatibility testing — but **not to IVD analysers** intended for those applications. See [Evaluation Routes](../registration/evaluation-routes.md).
...
See [Grouping Types](../grouping/grouping-types.md) for full detail.
