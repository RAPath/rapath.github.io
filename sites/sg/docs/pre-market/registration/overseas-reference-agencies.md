---
sidebar_position: 3
title: Overseas Reference Regulatory Agencies
description: The five overseas reference regulatory agencies recognised by HSA for Singapore's abridged, expedited, and immediate evaluation routes — TGA, EU NB, Health Canada, MHLW, and FDA.
---
...
| **EU NB** — European Union Notified Bodies | EU/EEA | EC certificates (specific types — see [Evaluation Routes](./evaluation-routes.md)) |
...
See [Singapore vs TGA / FDA / CE / Health Canada](../../international/sg-vs-other-jurisdictions.md) for a fuller comparison.
