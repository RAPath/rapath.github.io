---
sidebar_position: 11
title: Digital Health and Software as a Medical Device (SaMD)
description: How HSA regulates software as a medical device (SaMD) in Singapore, including classification, registration routes, and the dedicated immediate registration pathway for medical mobile applications.
---
...
[hsa.gov.sg/medical-devices/digital-health](https://www.hsa.gov.sg/medical-devices/digital-health)

---

## What is SaMD?

**Software as a Medical Device (SaMD)** is software that is intended to be used for medical purposes and meets the [definition of a medical device](../../start-here/what-is-a-medical-device.md) under the Health Products Act — without being part of a hardware medical device.
...
Use the [HSA risk classification tool](https://www.hsa.gov.sg/medical-devices/registration/risk-classification) for a device-specific assessment.
...
AI/ML medical device products with novel architectures or intended uses that do not fit existing classification guidance are encouraged to engage HSA's **Innovation Office** early:
[hsa.gov.sg/medical-devices/io](https://www.hsa.gov.sg/medical-devices/io)
...
- [HSA: Digital Health programme](https://www.hsa.gov.sg/medical-devices/digital-health)
