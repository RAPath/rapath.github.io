---
sidebar_position: 12
title: Change Notification for Registered Devices
description: When and how to notify HSA before implementing changes to a registered medical device in Singapore — types of changes, notification requirements, and the change notification process.
---
...
Change notifications are submitted through the [SHARE portal](https://www.hsa.gov.sg/medical-devices/e-services).

## Official sources

- [HSA: Changes to registered devices](https://www.hsa.gov.sg/medical-devices/change-notification)
- [HSA: Field Safety Corrective Action](https://www.hsa.gov.sg/medical-devices/field-safety-corrective-action)
