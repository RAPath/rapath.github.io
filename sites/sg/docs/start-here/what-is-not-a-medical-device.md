...
description: Products that fall outside the definition of a medical device under Singapore's Health Products Act, and how HSA treats common borderline cases.
---

# What is Not a Medical Device?

Understanding exclusions is often as important as understanding the definition. Several common product categories are explicitly outside the scope of the [Health Products (Medical Devices) Regulations 2010](../legislation/hp-md-regulations.md), or fall outside scope based on their intended purpose.
...
Where a device *incorporates* a pharmacological substance in a secondary role (e.g. a drug-eluting stent), it is generally regulated as a **Class D medical device**. See [Borderline and Combination Products](./what-is-a-medical-device.md#borderline-and-combination-products).
...
Not all healthcare-related software is a medical device. Software is only within scope if it meets the **intended purpose test** described in the [main definition](./what-is-a-medical-device.md).
...
See [Digital Health and SaMD](../pre-market/registration/digital-health-samd.md) for HSA's classification approach to software.
...
- **"Is it a medical device?"** tool: [hsa.gov.sg/medical-devices/registration/is-it-a-medical-device](https://www.hsa.gov.sg/medical-devices/registration/is-it-a-medical-device)
- **Risk classification tool**: [hsa.gov.sg/medical-devices/registration/risk-classification](https://www.hsa.gov.sg/medical-devices/registration/risk-classification)
