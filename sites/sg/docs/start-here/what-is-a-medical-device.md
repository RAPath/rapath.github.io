...
description: The definition of a medical device under Singapore's Health Products Act, including the intended purpose test, examples, and borderline products.
keywords: [medical device definition, Health Products Act, HSA, Singapore, intended purpose]
---
...
- is intended by the manufacturer to be used, whether alone or in combination, for human beings for one or more of the following specific purposes:
...
- and does not achieve its principal intended action by pharmacological, immunological, or metabolic means — though it may be assisted in its function by such means.

The full definition appears in section 2 of the Health Products Act and is replicated in regulation 2 of the [Health Products (Medical Devices) Regulations 2010](../legislation/hp-md-regulations.md).
...
HSA provides an online **"Is it a medical device?" tool** at the [SHARE portal](https://www.hsa.gov.sg/medical-devices/registration/is-it-a-medical-device) to help manufacturers and importers determine whether their product falls within scope.
...
See [What is Not a Medical Device](./what-is-not-a-medical-device.md) for a fuller treatment of boundary cases.
...
- **Software and digital health products**: software that meets the intended purpose test is regulated as a medical device (SaMD). HSA has published specific guidance on the SaMD classification pathway — see [Digital Health and SaMD](../pre-market/registration/digital-health-samd.md).

For borderline cases, HSA's [Consultation Schemes](https://www.hsa.gov.sg/medical-devices/consultation-schemes) and the [Innovation Office](https://www.hsa.gov.sg/medical-devices/io) offer pre-submission advisory services.

---

## Official sources

- [Health Products Act (Cap. 122D) — Singapore Statutes Online](https://sso.agc.gov.sg/Act/HPA2007)
