---
sidebar_position: 6
title: Class A — Exemption and Notification
description: Class A medical devices in Singapore are exempt from product registration, but a product notification must still be submitted via SHARE. This page explains what Class A means and what is still required.
---
...
This exemption is set out in the [Health Products (Medical Devices) Regulations 2010](../legislation/hp-md-regulations.md) and confirmed on the [HSA regulatory overview page](https://www.hsa.gov.sg/medical-devices/regulatory-overview):
...
Classification is always determined by applying the [HP(MD) Regulations classification rules](../pre-market/classification/classes-a-b-c-d.md), not by assumption. If there is any doubt, use HSA's [risk classification tool](https://www.hsa.gov.sg/medical-devices/registration/risk-classification).
...
1. Log in to the [SHARE portal](https://www.hsa.gov.sg/medical-devices/e-services).
2. Select the Class A product notification application type.
3. Complete the product details — device name, intended purpose, manufacturer, risk classification.
4. Submit and retain the notification reference number.
...
- [HSA: Regulatory overview — Class A exemption](https://www.hsa.gov.sg/medical-devices/regulatory-overview)
- [HSA: Registration overview — Class A](https://www.hsa.gov.sg/medical-devices/registration/overview)
