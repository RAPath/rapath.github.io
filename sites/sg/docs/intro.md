...
| [Dealer's Licence](./dealers-licence/overview.md) | Who needs a licence, manufacturer/importer/wholesaler distinctions, QMS and GDP requirements, applying via SHARE, audit process, maintaining and renewing |
...
| [What's New](./whats-new/regulatory-changes.md) | Recent regulatory changes, open consultations, upcoming changes, reforms tracker |
