...
description: Terms of use, disclaimer, and limitation of liability for RAPath — the global medical device regulatory reference.
---
...
RAPath does not collect personal data directly. The site is hosted on GitHub Pages, which may collect server logs in accordance with [GitHub's Privacy Statement](https://docs.github.com/en/site-policy/privacy-policies/github-general-privacy-statement). Search functionality is provided by Algolia DocSearch, which operates under [Algolia's Privacy Policy](https://www.algolia.com/policies/privacy/).
