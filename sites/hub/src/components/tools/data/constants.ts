import {
  ...
  RefreshCw, ClipboardCheck, Users, Award, Cpu,
...
export const TOOLS: Tool[] = [
  ...
  { id:"compare",  cat:"general", name:"Jurisdiction Comparison Tables",
    ...
    desc:"Side-by-side comparison of PMS, UDI, authorised reps, vigilance, and QMS across 16 markets." },
  ...
  { id:"glossary", cat:"general", name:"Acronym & Glossary Lookup",
    ...
    desc:"Searchable glossary of 100+ regulatory terms and acronyms across all 16 jurisdictions." },
  ...
  { id:"pmo",      cat:"mfr", name:"Post-Market Obligations Calendar",
    ...
    desc:"What you must do — and when — after market entry. Vigilance timeframes, PSUR cycles, renewal windows across 8 jurisdictions." },
  ...
  { id:"checklist", cat:"import", name:"Submission Readiness Checklist",
    ...
    desc:"Track submission readiness across 24 items with a live progress bar." },
