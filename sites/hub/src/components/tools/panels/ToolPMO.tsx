...
const VIGILANCE = [
  ...
  {jur:"🇳🇿 Medsafe",        death:"48 hours",         serious:"10 working days",other:"30 calendar days",  trend:"Mirrors TGA timeframes; reports to Medsafe"},
];
...
const RENEWALS = [
  ...
  {jur:"🇳🇿 NZ",  reg:"Medsafe",         freq:"Ongoing / annual review",     notes:"Medsafe registration/notification requires annual review or update. Therapeutic Products Act 2023 phased implementation."},
];
