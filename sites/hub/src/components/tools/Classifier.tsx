...
import {
  Stethoscope, ArrowLeft, ArrowRight, CheckCircle2,
  ...
  return (
    <div>
      <p style={{ fontSize:14, color:"#64748b", lineHeight:1.7, marginBottom:24 }}>
        ...
        required documentation, and pathway timelines across all 16 RAPath jurisdictions.
      </p>
...
export function Classifier(): JSX.Element {
  ...
  const handleAnswer = (id: string, val: string) => {
    ...
    else { setResults(getResults(next)); setScreen("results"); }
  };
  ...
  // Software track: pre-select software=pure_sw on Q1 and jump to question 1 (purpose)
  const startSaMD = () => {
    setAnswers({ software: "pure_sw" });
    setStep(0); // start at purpose question
    setScreen("questions");
  };
