...
title: FAQ
sidebar_position: 4
description: Frequently asked questions on MDA registration, LAR requirements, Class A notification, MyMDA portal, and post-market obligations for medical devices in Malaysia.
---
...
Yes. The MDA maintains a public register of registered devices accessible via the **MyMDA portal** at [mymda.mda.gov.my](https://mymda.mda.gov.my).
...
A GMDN (Global Medical Device Nomenclature) code is required for registration. Search for or register your device at [www.gmdnagency.org](https://www.gmdnagency.org). Some device types may require a new GMDN term to be created — this takes additional time.
