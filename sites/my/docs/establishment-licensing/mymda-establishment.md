---
title: MyMDA Portal — Establishment Licensing
sidebar_position: 6
description: Step-by-step guide to applying for an establishment licence via the MyMDA online portal, including document preparation tips and common pitfalls.
---
...
**Portal URL:** [https://mymda.mda.gov.my](https://mymda.mda.gov.my)
...
- [ ] Email address for official MDA correspondence (use a monitored shared regulatory email account with multiple users; avoid personal or individual email addresses to prevent loss of regulatory communications if the individual leaves the organisation)
...
- Navigate to [mymda.mda.gov.my](https://mymda.mda.gov.my)
