---
title: Establishment Licence Overview
sidebar_position: 1
description: Overview of establishment licensing requirements under Malaysia's Medical Device Act 2012 (Act 737) for manufacturers, importers, and distributors.
---
...
1. Be a legally registered business entity in Malaysia
2. Have a physical address in Malaysia
3. Maintain a Quality Management System (QMS) appropriate to the activities performed
4. Designate a qualified **Person Responsible for Regulatory Compliance (PRRC)** or equivalent responsible person
5. Maintain records as required by MDA
