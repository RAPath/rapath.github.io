---
title: Importer Licence
sidebar_position: 3
description: Requirements for importing medical devices into Malaysia, including importer establishment licensing, QMS expectations, and post-market responsibilities.
---
...
1. Verify the device is registered with MDA before import and supply
2. Verify the foreign manufacturer holds appropriate QMS certification
3. Maintain records sufficient to trace products to their destination
4. Report serious adverse events to MDA
5. Cooperate with MDA inspections and audits
6. Implement recalls and FSCAs as directed by the manufacturer or MDA
