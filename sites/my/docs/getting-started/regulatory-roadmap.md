...
sidebar_position: 6
description: End-to-end visual pathway for bringing a medical device to market in Malaysia, from product identification through to post-market obligations.
---
...
→ See [What is a Medical Device?](./what-is-a-medical-device.md) and [Is Your Product a Medical Device?](./is-your-product-a-medical-device.md)
...
→ See [Establishment Licensing](../establishment-licensing/establishment-licence-overview.md)
...
→ See [Device Registration](../device-registration/registration-overview.md)
...
→ See [Post-Market Requirements](../post-market-requirements/post-market-surveillance.md)

:::tip Start with Classification
