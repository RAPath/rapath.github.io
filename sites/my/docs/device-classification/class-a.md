---
title: Class A — Low Risk
sidebar_position: 2
description: Classification criteria, regulatory obligations, and notification pathway for Class A (lowest risk) medical devices under Malaysia's Medical Device Act 2012.
---
...
:::note Sterile Class A vs Standard Class A
...
1. Manufacturer/LAR completes self-declaration of conformity to Essential Principles
2. Submits notification via **MyMDA portal** with:
   - Device description and intended purpose
   - Classification justification
   - Self-declaration of conformity
   - Label and IFU
3. MDA acknowledges the notification
4. Device receives a **Device Registration Number (DRN)**
...
:::warning Self-Declaration Responsibility
