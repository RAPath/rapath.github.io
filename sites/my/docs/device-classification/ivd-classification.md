...
sidebar_position: 6
description: In vitro diagnostic device classification under Malaysia's Medical Device Act 2012 and Medical Device Regulations 2012.
---
...
1. **Intended Use is Primary** — an IVD intended for self-testing is classified higher than the same IVD intended for professional lab use
2. **Annex Lists are Definitive** — if your IVD is listed in Annex II, it is classified at that level regardless of other factors
3. **Novel IVDs** — novel IVDs not fitting existing categories are classified based on risk to individual and public health
