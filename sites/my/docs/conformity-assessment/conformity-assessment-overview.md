---
title: Conformity Assessment Overview
sidebar_position: 1
description: Overview of conformity assessment routes in Malaysia, including QMS certification, technical documentation review, and the role of recognised assessment bodies.
---
...
MDA requires evidence of conformity assessment as part of the device registration dossier for all Class B, C, and D devices. For sterile Class A devices, conformity assessment evidence is strongly recommended but not mandatory.

## Essential Principles

The Essential Principles are derived from GHTF/SG3 and are detailed in Schedule 2 of the Medical Device Regulations 2012. They require that medical devices:

1. Are safe and effective for their intended purpose
2. Do not unnecessarily compromise the safety of patients, operators, or third parties
3. Meet the intended performance claimed by the manufacturer
4. Are designed and manufactured to minimise risk
5. Maintain performance throughout their expected lifetime

Manufacturers demonstrate conformity to Essential Principles primarily through:
- Compliance with applicable harmonised or MDA-recognised standards (such as ISO 13485 for QMS, ISO 14971 for risk management, and device-specific standards)
...
Third-party examination by a MDA-recognised CAB of a representative device specimen
Assessment of technical documentation against Essential Principles
Typically used when QMS certification alone is insufficient to demonstrate conformity, particularly for novel Class C and D applications
Manufacturer must maintain a current ISO 13485 certificate in parallel
...
CABs recognised by MDA include international notified bodies (e.g., BSI, TÜV SÜD, SGS, Intertek) and regional testing organisations. A current list of MDA-recognised CABs is available on the MDA website (www.bpfk.gov.my/mda) and should be consulted before submitting a dossier to confirm the CAB's scope of recognition for your device type.
