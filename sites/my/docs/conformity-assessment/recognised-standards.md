...
sidebar_position: 5
description: List of harmonised and MDA-recognised standards for medical device conformity assessment in Malaysia, with guidance on applicability per device type.
---
...
1. Identify all Essential Principles applicable to your device
2. For each Essential Principle, identify the most current applicable standard(s)
3. Verify compliance through testing, design analysis, or other means
4. Document compliance (or justified partial compliance) in the Essential Principles checklist in the technical file
