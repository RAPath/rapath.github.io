...
sidebar_position: 2
description: Mandatory adverse event (vigilance) reporting requirements for medical devices in Malaysia, including reportable events, timelines, and MDA reporting process.
---
...
1. Log into MyMDA
2. Navigate to **Post-Market** → **Adverse Event Report**
3. Complete the adverse event report form:
