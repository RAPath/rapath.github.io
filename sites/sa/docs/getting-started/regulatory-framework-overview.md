...
sidebar_position: 5
description: An overview of Saudi Arabia's medical device regulatory system — the SFDA, the Medical Devices Law, GHAD portal, and how the framework compares to EU MDR.
---
...
1. **Appoint an Authorized Representative (AR)** — mandatory for foreign manufacturers
2. **Classify the device** — using MDS-REQ 1 classification rules (Class A → D)
3. **Prepare the Technical File** — following MDS-REQ 1 Annex 3 structure
4. **Apply via GHAD** — the SFDA's unified electronic submission portal
5. **Pay the application fee** — invoiced by SFDA after submission check
6. **SFDA review** — may include queries; approval issued as MDMA certificate
7. **Comply post-market** — PMS, vigilance, UDI, MDMA renewal
