...
sidebar_position: 6
description: Regulatory obligations for foreign manufacturers, Authorized Representatives, importers, distributors, and healthcare providers under the SFDA Medical Devices Law.
---
...
1. **Appointing an Authorized Representative (AR)** licensed by the SFDA
2. **Obtaining MDMA** for each device or group of devices (via TFA)
3. **Implementing and certifying a QMS** to ISO 13485 (or SFDA.MD/GSO ISO 13485)
4. **Fulfilling post-market obligations** — PMS, vigilance, MDMA renewal
