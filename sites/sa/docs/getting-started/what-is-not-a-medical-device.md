...
sidebar_position: 2
description: Products and categories that fall outside the SFDA medical device definition and are therefore not subject to MDMA requirements.
---
...
1. Review the manufacturer's intended purpose as stated on labelling, IFU, and marketing materials
2. Apply the SFDA definition in Article 1 of the Medical Devices Law
3. Consider whether the principal action is pharmacological, immunological, or metabolic (if so, likely a drug not a device)
4. Consult MDS-G008 for borderline classification guidance
5. If still uncertain, contact the SFDA via your AR
