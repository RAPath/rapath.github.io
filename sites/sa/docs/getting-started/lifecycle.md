---
title: Lifecycle of a Medical Device in Saudi Arabia
sidebar_position: 7
description: End-to-end journey of a medical device in the Saudi market — from classification and AR appointment through MDMA, post-market, and renewal.
---
...
→ [Authorized Representative Overview](../authorized-representative/ar-overview.md)
...
→ [Quality System](../quality-system/iso-13485-overview.md)
...
→ [Technical Documentation](../technical-documentation/technical-file-overview.md)
...
→ [SFDA Review Timelines](../mdma-registration/review-timelines.md)
...
→ [UDI Requirements](../udi/udi-overview.md)
...
- [MDMA Registration](../mdma-registration/mdma-overview.md)
- [Post-Market Overview](../post-market/overview.md)
