---
title: GHAD Portal — Electronic Submission
sidebar_position: 3
description: An overview of the SFDA's GHAD unified electronic system — how to register, submit MDMA applications, manage MDEL licensing, and track application status.
---
...
:::tip Manufacturer direct submission
...
### MDMA application
1. Register / log into GHAD
2. Create a new MDMA application
3. Enter device details (name, classification, intended use, models)
4. Upload technical file sections per MDS-REQ 1 Annex 3 structure
5. Submit application — triggers SFDA completeness check
6. Receive invoice via GHAD — pay online
7. Monitor application status and respond to queries via GHAD messaging
