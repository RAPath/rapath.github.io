...
title: MDMA Overview
sidebar_position: 1
description: Medical Device Marketing Authorization (MDMA) — what it is, who needs it, the TFA pathway, and the key steps from application to certificate.
---
