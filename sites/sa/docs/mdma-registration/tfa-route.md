---
title: MDMA-2 — Technical File Assessment (TFA)
sidebar_position: 2
description: The Technical File Assessment (TFA) route — Saudi Arabia's single MDMA registration pathway since 2022, and how it differs from the cancelled GHTF route.
---
...
:::info Existing MDMA-1 certificates
...
During technical review, the SFDA's evaluation team may issue one or more query letters via GHAD requesting clarifications, additional testing data, or supporting documentation to complete the assessment. The manufacturer (via AR) must respond within the timeframe specified. Delayed or inadequate responses are a common cause of extended review timelines.
