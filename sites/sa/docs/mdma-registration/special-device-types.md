...
sidebar_position: 6
description: SFDA regulatory approach for special device categories — radiation-emitting devices, devices incorporating medicinal substances, custom devices, novel devices, and export-only imports.
---
