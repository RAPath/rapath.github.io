...
SaMD requires MDMA (Medical Device Marketing Authorization) via TFA (Technical File Application) through the GHAD portal, like any other medical device, unless it qualifies for an export-only exemption. The technical file for software must address:
...
Replace the awkwardly placed parenthetical: Change 'Software used solely to support device hardware (device operating software with no independent medical function) is generally not a separate medical (Medical Device Marketing Authorization) (Technical File Application) through the GHAD portal, device, unless it qualifies for an export-only exemption.' to 'Software used solely to support device hardware (device operating software with no independent medical function) is generally not a separate medical device requiring MDMA through the GHAD portal, unless it qualifies for an export-only exemption.'
