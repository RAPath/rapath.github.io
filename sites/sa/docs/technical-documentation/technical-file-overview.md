---
title: Technical File Overview
sidebar_position: 1
description: Structure and content requirements for the SFDA Technical Documentation File (TDF) under MDS-REQ 1 Annex 3.
---
...
The Technical Documentation File (TDF) must be submitted in English and structured according to MDS-REQ 1 Annex 3. The TDF is a living document that must be updated and maintained current throughout the device's market lifecycle, including after MDMA approval when device changes, post-market data, or new clinical evidence emerge.
