...
sidebar_position: 4
description: SFDA clinical evaluation requirements — what data is needed by device class, the Clinical Evaluation Report, and use of overseas clinical data.
---
...
1. **Scope of clinical evaluation** — intended purpose, claims, populations
2. **Literature review** — systematic search of published evidence for this device type
3. **Equivalence** — demonstration that equivalent devices share same intended use, technical and biological characteristics (with documented evidence)
4. **Clinical investigation data** — where available or required
5. **Post-market clinical data** — PMCF and PMS data for marketed devices
6. **Overall conclusion** — whether clinical evidence supports the intended purpose and that the benefit-risk profile is acceptable
