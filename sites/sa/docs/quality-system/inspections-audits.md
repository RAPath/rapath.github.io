---
title: SFDA Inspections & Audits
sidebar_position: 3
description: SFDA inspection authority — when SFDA inspects manufacturing sites, what to expect, and how to respond to SFDA non-conformity findings.
---
...
1. Acknowledge the finding promptly via GHAD or official correspondence
2. Conduct root cause analysis
3. Implement corrective actions
4. Provide a written CAPA response to the SFDA within the specified timeframe
5. Provide evidence of corrective action implementation
