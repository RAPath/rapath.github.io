---
title: PMS & PSUR Requirements
sidebar_position: 4
description: Post-market surveillance obligations by device class in Saudi Arabia — PMS Reports for Class A and Periodic Safety Update Reports (PSURs) for Class B, C, and D.
---
...
| Class | Required report | Update frequency |
|---|---|---|
| **Class A** | PMS Report | As needed; available on SFDA request |
| **Class B** | Periodic Safety Update Report (PSUR) | At least every 2 years |
| **Class C** | PSUR | Annually |
...
- MDS-REQ 5 — PMS and vigilance requirements
