---
title: MDMA Renewal & Change Notification
sidebar_position: 5
description: How to renew an MDMA certificate in Saudi Arabia and how to notify the SFDA of significant device changes.
---
...
1. Submit the renewal application before the certificate expires
2. Provide updated technical file sections (where changes have occurred)
3. Submit updated PSUR / PMS data confirming continued safety and performance
4. Pay the renewal fee
5. SFDA reviews the renewal; updated MDMA certificate issued

:::warning MDMA-1 renewals → TFA required
