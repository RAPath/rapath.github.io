---
title: Adverse Event Reporting — NCMDR
sidebar_position: 2
description: Reporting serious incidents and adverse events to the SFDA via the National Centre for Medical Device Reporting (NCMDR) — obligations, timeframes, and process.
---
...
1. Complete the adverse event report form
2. Submit via GHAD or designated NCMDR reporting channel
3. SFDA/NCMDR acknowledges receipt
4. Investigation and follow-up as required by SFDA
5. Provide supplementary information on SFDA request
