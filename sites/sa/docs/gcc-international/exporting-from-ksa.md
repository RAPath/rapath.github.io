---
title: Exporting from KSA — Certificate Requirements
sidebar_position: 6
description: Requirements for exporting medical devices manufactured in Saudi Arabia to other markets — SFDA export certificates and regulatory documentation.
---
...
| Destination | Key registration requirement |
|---|---|
| EU | CE marking under EU MDR/IVDR |
