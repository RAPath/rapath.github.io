---
title: SFDA vs Other Regulators
sidebar_position: 4
description: How the SFDA compares to EU MDR, US FDA, TGA, and HSA — key similarities and differences for multi-market manufacturers.
---
...
In the 'Registration' row under SFDA column, change 'MDMA (TFA)' to 'MDMA (Technical File Assessment / TFA)' to make the acronym expansion explicit on first use.
