---
title: Classification Guidance — MDS-G008
sidebar_position: 9
description: The SFDA's MDS-G008 classification guidance document — how to use it, what it covers, and when to apply it for borderline and difficult classification cases.
---
...
1. Identify the applicable classification rule(s) from MDS-REQ 1
2. Reference MDS-G008 where interpretation is needed
3. State the final class and the specific rule number(s) that led to that class
4. Note if the highest applicable rule was applied (where multiple rules apply)
5. Include a brief rationale if the classification is non-obvious
