---
title: Medical Device Importing License (MDIL)
sidebar_position: 4
description: The MDIL — when it applies instead of MDMA, which device categories are MDIL-eligible, and how to apply.
---
...
| Feature | MDIL | MDMA |
|---|---|---|
| Full technical file required | No | Yes |
| AR required | May not apply | Yes |
| For commercial market entry | No | Yes |
| Scope | Limited exempted categories | All devices for market |
