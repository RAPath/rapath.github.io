---
title: IVD Registration Update
sidebar_position: 2
description: Status of IVD registration requirements in the Philippines — currently exempt, upcoming implementation tracker.
---

# IVD Registration — Current Status & Upcoming Requirements
...
- This situation is **transitional** — the Philippines has signalled intention to introduce mandatory IVD registration
...
- Follow the **ASEAN AMDD IVD classification framework** (IVD Class A–D)
...
## Action Items for IVD Manufacturers

1. **Confirm current status**: Check the CDRRHR website for the latest announcement on IVD registration implementation date
2. **Obtain LTO now**: Ensure your Philippines LTO is in place as an importer/distributor — this is required regardless of IVD registration status
...
This page is updated as new information becomes available from CDRRHR. Check the **CDRRHR website** for formal implementation announcements:
[www.fda.gov.ph/center-for-device-regulation-radiation-health-and-research/](https://www.fda.gov.ph/center-for-device-regulation-radiation-health-and-research/)
