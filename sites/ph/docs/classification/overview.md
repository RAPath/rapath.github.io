...
sidebar_position: 1
description: Philippines medical device classification — ASEAN AMDD Class A–D, IVD exemption, and product classification inquiry process.
---

# Classification Overview

> *FDA Philippines / CDRRHR · ASEAN AMDD · Class A · B · C · D*

## Four-Class Risk System — ASEAN AMDD
...
1. **Intended purpose** — as stated by the manufacturer; the starting point for classification
2. **Invasiveness** — non-invasive, orifice-invasive, surgically invasive, implantable
3. **Duration of contact** — transient (< 60 min), short-term, long-term (>30 days)
4. **Active vs non-active** — energy-dependent devices classified higher at equivalent invasiveness
5. **Anatomical location** — CNS, cardiovascular, or blood-stream contact = higher risk

**Tie-breaking:** Where multiple rules apply, the **highest class** determined by any applicable rule governs.

## IVD Classification — Current Philippines Status — PH-Unique

IVD classification exists within the ASEAN AMDD framework (IVD Class A–D), but as of May 2026:
...
1. Prepare a written classification inquiry letter including:
   - Full device description
   - Intended purpose
   - Materials
   - Manufacturer information
2. Submit to CDRRHR
3. CDRRHR provides a written classification determination
