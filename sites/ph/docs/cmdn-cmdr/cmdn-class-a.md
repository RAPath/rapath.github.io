---
title: CMDN — Class A Device Notification
sidebar_position: 1
description: Certificate of Medical Device Notification (CMDN) — Class A pathway in Philippines FDA, documentation requirements, and processing timeline.
---

# CMDN — Class A Device Notification
...
Note: IVDs are currently exempt from registration requirements — see [What Is a Medical Device?](/getting-started/what-is-a-medical-device).
