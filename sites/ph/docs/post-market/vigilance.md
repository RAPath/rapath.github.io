...
sidebar_position: 2
description: Philippines CDRRHR adverse event reporting, eReport system, FSCA obligations, and recall coordination.
---
...
Borderline cases (events that may or may not meet the threshold) should be reported — CDRRHR can advise whether a full report is required.
...
|-----------|-----------|
| Death or serious injury | As soon as possible — within 10 calendar days |
