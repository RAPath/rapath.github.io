...
sidebar_position: 1
description: Indonesia's emergency use authorization (EUA) pathway for medical devices — eligibility, documentation, approval scope, and post-emergency transition.
---
