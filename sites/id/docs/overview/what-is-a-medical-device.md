...
sidebar_position: 1
description: How Indonesian law defines a medical device, what products are in scope, and what is explicitly excluded from the regulatory framework.
---
...
1. Intended by the manufacturer to be used for human beings for one or more of the following purposes:
...
2. Does **not** achieve its principal intended action by pharmacological, immunological, or metabolic means — though it may be assisted by such means.
...
See also the [Key Legislation](./key-legislation.md) page for a full list of applicable regulations.
