...
sidebar_position: 2
description: The registration pathways available for medical devices in Indonesia — standard by class, expedited using foreign approvals, and simplified notification for Class A.
---
...
1. LAR obtains IDAK + CDAKB certification (prerequisite)
2. Manufacturer and LAR prepare the ASEAN CSDT dossier
3. LAR submits through Regalkes
4. Administrative review by Kemenkes (completeness check)
5. PNBP fee payment triggered on passing administrative review
6. Technical review by Kemenkes evaluators
7. Clarification rounds (typically at least one)
8. NIE issued on approval
