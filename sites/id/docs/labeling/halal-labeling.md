---
title: Halal Labeling (GR 42/2024)
sidebar_position: 3
description: Indonesia's phased mandatory Halal labeling compliance requirements under Government Regulation 42/2024 — deadlines by class, non-halal declaration rules, and preparation steps.
---
...
Option 1: Obtain Halal Certification
The device and its supply chain undergo Halal audit and certification by a recognised Indonesian Halal certification body (under the Halal Product Assurance Organising Agency, BPJPH). The certified device may carry the official Halal logo (MUI halal logo or BPJPH-issued logo).

Option 2: Non-Halal Declaration
If the device contains materials derived from sources that are not Halal under Islamic law (e.g. porcine-derived materials, certain animal-derived biologicals), full certification may not be achievable. GR 42/2024 requires that such devices:
