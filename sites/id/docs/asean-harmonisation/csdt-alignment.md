---
title: CSDT Alignment
sidebar_position: 2
description: How the ASEAN CSDT maps to Indonesia's Regalkes submission format — adapting dossiers from other ASEAN submissions for use in Indonesia.
---
...
BPOM's Regalkes submission portal requires dossiers to follow the CSDT module structure with the following country-specific additions:
