...
sidebar_position: 1
description: How Indonesia classifies medical devices into four risk classes (A–D) using ASEAN/GHTF-aligned rules based on invasiveness, duration of contact, and intended use.
---
...
1. **Determined by the manufacturer** based on the GHTF/ASEAN classification rules
2. **Declared in the registration dossier** submitted through Regalkes
3. **Reviewed and confirmed** by Kemenkes evaluators during the technical review phase
...
The GHTF SG1 Study Group documents, particularly **GHTF/SG1/N77:2012 provides guidance on regulatory auditing of QMS; for classification methodology specifically, refer to GHTF classification guidance documents and the ASEAN AMDD Classification Annex** and **GHTF/SG1/N71:2012 — Summary Technical Documentation (STED)**, are key references for understanding how Indonesia's framework maps to international norms.

If a manufacturer disagrees with the Kemenkes classification determination during technical review, the LAR can submit a written justification to the evaluator with additional supporting evidence or alternative classification rationale. The evaluator will reconsider the classification based on the submitted documentation. Classification changes at this stage are possible but must be supported by clear evidence aligned with GHTF/ASEAN classification criteria.assification and communicate the final determination in the deficiency letter or approval decision. There is no formal appeal process; however, manufacturers can request pre-submission meetings with Kemenkes to clarify classification before submitting the full registration dossier.

after 'Reviewed and confirmed by Kemenkes evaluators': 'If a manufacturer disagrees with the Kemenkes classification determination during technical review, the LAR can submit a written justification to the evaluator with additional supporting evidence or alternative classification rationale. The evaluator will reconsider the classification and communicate the final determination in the deficiency letter or approval decision. There is no formal appeal process; however, manufacturers can request pre-submission meetings with Kemenkes to clarify classification before submitting the full registration dossier.

Clarify the GHTF reference section by adding: 'The GHTF SG1 Study Group Classification Guidance (referenced through ASEAN AMDD Annex) provides the foundational risk-based classification methodology that Indonesia applies. Additional quality system guidance is provided in GHTF/SG1/N77:2012.'
