---
title: Class B — Low to Moderate Risk
sidebar_position: 3
description: Class B medical devices in Indonesia — standard registration pathway, documentation requirements, timelines, and key examples.
---
...
| Document | Required for Class B? |
|---|---|
| Letter of Authorization (LoA) — apostilled | Yes |
| Free Sale Certificate (CFS/FSC) — apostilled | Yes |
| GMP Certificate | Yes |
| ISO 13485 Certificate | Yes (mandatory for imports) |
| Device description, intended use, IFU | Yes |
