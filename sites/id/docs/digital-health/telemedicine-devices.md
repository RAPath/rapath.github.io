...
A cybersecurity risk management approach should address threats to confidentiality, integrity, and availability of device functions and data. Reference IEC 62304 (medical device software lifecycle) and IEC 80001 (network security) as applicable frameworks. Kemenkes evaluators expect documentation of the cybersecurity risk management process, how security updates will be managed post-launch, and a clear description of whether firmware/software updates trigger re-registration or require change notification (Perubahan) through Regalkes.

Add to Device Registration Requirements section after 'Cybersecurity risk assessment': 'A cybersecurity risk management approach should address threats to confidentiality, integrity, and availability of device functions and data. Reference IEC 62304 (medical device software lifecycle) and IEC 80001 (network security) as applicable frameworks. Kemenkes evaluators expect documentation of how security updates will be managed post-launch and whether firmware/software updates trigger re-registration requirements.'

Update the Personal Data Protection section to clarify: 'The Personal Data Protection Law (Undang-Undang Perlindungan Data Pribadi No. 27 of 2022, abbreviated UU PDP) came into force on January 1, 2024. This is a new and evolving regulatory framework, and manufacturers should ensure compliance documentation is updated as Kemenkes guidance on UU PDP interaction with device regulation develops.'
