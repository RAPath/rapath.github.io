...
sidebar_position: 3
description: Step-by-step guide to submitting a medical device registration application through Indonesia's Regalkes portal — from account login to NIE issuance.
---
...
On passing: a **PNBP billing notice** is generated.
On failing: the application is returned with a list of deficiencies.
