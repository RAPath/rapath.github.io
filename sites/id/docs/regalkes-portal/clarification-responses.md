---
title: Responding to Clarifications
sidebar_position: 4
description: How to respond to clarification queries from Kemenkes evaluators via Regalkes — typical questions raised, response protocols, and impact on approval timelines.
---
...
1. **Notification**: Kemenkes issues the query through Regalkes; the LAR is notified (via the portal and sometimes by email)
2. **LAR informs manufacturer**: The LAR shares the query content with the foreign manufacturer
3. **Manufacturer prepares response**: Draft the response and any additional documents needed
4. **LAR uploads response**: Via Regalkes, within the response time window
5. **Evaluator reviews response**: If satisfactory, review continues; if not, a further round of queries may follow
