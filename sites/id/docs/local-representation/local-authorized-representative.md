---
title: Local Authorized Representative (LAR)
sidebar_position: 1
description: The mandatory Local Authorized Representative (LAR) requirement for foreign manufacturers — roles, responsibilities, selection criteria, and key risks.
---
...
Appoint an independent professional licence-holding service as the NIE holder (separate from your commercial distributor). This is increasingly the preferred approach for foreign manufacturers — see [Neutral Licence Holder](./neutral-licence-holder.md).
...
The formal appointment of your LAR is documented in a **Letter of Authorization (LoA)**. This is one of the most critical documents in the registration dossier. See [Letter of Authorization](./letter-of-authorization.md) for full requirements.

LAR Termination and NIE Status

If you terminate the relationship with your LAR, notify Kemenkes in writing via Regalkes. The NIE does not automatically transfer to a new LAR — the registration remains held by the original LAR entity. Depending on your contractual arrangement (distributor vs. neutral licence holder), the new LAR will typically need to submit a fresh NIE registration application with the new holder's IDAK and CDAKB details. The original NIE is not transferred; the old NIE remains with the original holder (or is cancelled at their request) and a new NIE is issued to the new holder. Plan exit provisions and transition timelines carefully before appointing a LAR, particularly if using a commercial distributor.
