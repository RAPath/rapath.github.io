...
sidebar_position: 5
description: Clinical evidence requirements for Indonesian medical device registration by class — literature review, clinical evaluation reports, and local clinical investigation data.
---
...
1. **BPOM approval** is required before any investigation commences
2. **Ethics committee clearance** from an accredited Indonesian ethics committee
