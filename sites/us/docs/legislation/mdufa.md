---
sidebar_position: 4
title: Medical Device User Fee Amendments (MDUFA VI)
description: MDUFA VI — the current medical device user fee agreement (FY2023–2027), performance goals, fee levels, and how MDUFA shapes FDA device review.
keywords: [MDUFA, MDUFA VI, device user fees, 510k fees, PMA fees, FDA performance goals, MDUFA timeline]
---
...
|---------|--------|-------------|
| MDUFMA (I) | FY2003–2007 | First device user fee legislation |
...
| Submission type | Total Time to Decision goal |
|---|---|
| 510(k) — standard | 90 calendar days |
| 510(k) — Special | 30 calendar days |
| De Novo request | 150 calendar days |
| Original PMA | 180 calendar days |
| PMA Panel Track Supplement | 180 calendar days |
| PMA Real-Time Supplement | 90 calendar days |
...
Fees are updated annually each October. Check [FDA's user fee website](https://www.fda.gov/industry/fda-user-fee-programs/medical-device-user-fee-amendments-mdufa) for current amounts.
...
## Official resources
- [FDA — MDUFA VI](https://www.fda.gov/industry/fda-user-fee-programs/medical-device-user-fee-amendments-mdufa)
