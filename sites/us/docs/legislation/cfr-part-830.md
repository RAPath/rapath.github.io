...
description: 21 CFR Part 830 — the UDI regulation requiring device labels to bear a unique device identifier, and device information to be submitted to the GUDID database.
keywords: [21 CFR Part 830, UDI, unique device identification, GUDID, device identifier, production identifier]
---
