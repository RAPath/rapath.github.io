---
sidebar_position: 4
title: PMA Supplements & Amendments
description: How to make changes to an approved PMA — supplement types, 180-day supplements, real-time supplements, and 30-day notices.
keywords: [PMA supplement, PMA amendment, PMA changes, 180-day supplement, real-time supplement, 30-day notice]
---
...
| **Real-Time Supplement** | Minor modifications with well-established assessment methods | 30–90 days |
...
## Changes that do NOT require a supplement
...
Other changes may qualify for **documentation only** — included in the annual PMA report but requiring no prior FDA notification.
...
- [FDA — Modifications to Approved PMA Guidance](https://www.fda.gov/media/99961/download)
