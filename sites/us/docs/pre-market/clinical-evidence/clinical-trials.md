---
sidebar_position: 4
title: Clinical Trials in the USA
description: How to conduct FDA-regulated medical device clinical trials in the USA — IDE, IRB, GCP requirements, and registration on ClinicalTrials.gov.
keywords: [device clinical trial USA, IDE study, GCP, ClinicalTrials.gov, FDA clinical investigation]
---
...
- **ICH E6 (R2)** — GCP guidelines (adopted by FDA for device trials)
...
| Adverse event reporting (during study) | 21 CFR § 812.150 |
