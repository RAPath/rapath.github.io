---
sidebar_position: 5
title: 510(k) Submission Contents & Checklist
description: What to include in a 510(k) submission — required elements, eSTAR format, and the FDA acceptance review checklist.
keywords: [510k contents, 510k checklist, 510k requirements, eSTAR, substantial equivalence report]
---
...
## Required elements (Traditional 510(k))
...
## Performance testing by device type
...
## The Refuse to Accept (RTA) checklist
