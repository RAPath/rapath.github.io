---
sidebar_position: 4
title: Traditional · Abbreviated · Special 510(k)
description: The three types of 510(k) submissions — Traditional, Abbreviated (with recognised standards), and Special (for device changes).
keywords: [traditional 510k, abbreviated 510k, special 510k, types of 510k, recognised standards]
---
...
The Abbreviated 510(k) uses FDA-recognised consensus standards (such as ISO or ASTM standards) to demonstrate conformity with established safety and effectiveness benchmarks. Rather than submitting full underlying test data, the submitter provides:
...
When to use: When relevant FDA-recognised standards exist for your device type. The FDA-recognised standards list is searchable at [accessdata.fda.gov](https://www.accessdata.fda.gov/scripts/cdrh/cfdocs/cfStandards/search.cfm).
...
- [FDA — Types of 510(k)s](https://www.fda.gov/medical-devices/premarket-submissions-selecting-and-preparing-correct-submission/types-510ks)
