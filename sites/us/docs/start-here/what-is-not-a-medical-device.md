---
sidebar_position: 2
title: What is Not a Medical Device?
description: Products excluded from the FDA medical device definition — drugs, biologics, food, cosmetics, and general wellness products.
keywords: [not a medical device, FDA exclusions, general wellness, cosmetics, drug device boundary]
---
...
## Products excluded by definition
...
### Cosmetics
Under 21 U.S.C. § 321(i), cosmetics are articles intended to be rubbed, poured, sprinkled, or sprayed on the body for cleansing, beautifying, or altering appearance. A moisturiser with no medical claims is a cosmetic; the same product labelled to treat dermatitis may become a drug or a combination product.

---

## General wellness products

FDA issued guidance titled "General Wellness: Policy for Low Risk Devices" (issued January 2019) establishing that certain low-risk general wellness products are not subject to FDA premarket oversight as medical devices if they: are intended only for general wellness uses (such as maintaining or encouraging a healthy lifestyle); and present a very low risk to the safety of users. This policy applies to devices that do not diagnose, treat, mitigate, cure, or prevent disease.
...
## Key borderline areas

| Product type | Status | Basis |
|---|---|---|
| Blood pressure cuff (consumer) | Medical device | Diagnostic intended use |
| Smart watch — heart rate only | Generally not a device | General wellness |
| Smart watch — AFib detection | Medical device | Diagnostic claim |
| UV light — tanning | Not a device | Cosmetic intended use |
| UV light — psoriasis treatment | Medical device / radiation-emitting device | Therapeutic claim |
...
## How to determine your product's status
...
- [FDA — General Wellness Policy for Low Risk Devices (2019)](https://www.fda.gov/media/90652/download)
- [FDA — Is My Product a Medical Device?](https://www.fda.gov/medical-devices/classify-your-medical-device/is-my-product-medical-device)
- [FDA — Combination Products](https://www.fda.gov/combination-products)
