---
sidebar_position: 3
title: Prescription vs OTC Device Labelling
description: The difference between prescription (Rx) and over-the-counter (OTC) device status — how it is determined and the labelling implications.
keywords: [prescription device, OTC device, Rx device, restricted device, 21 CFR 801.109, device labelling]
---

# Prescription vs OTC Device Labelling

## Prescription (Rx) devices

A device is a **prescription device** if it bears the statement restricting sale to the order of a licensed practitioner — typically because:
...
- Mandated by the applicable product classification regulation in 21 CFR Parts 862–892
...
## Official resources
- [21 CFR § 801.109](https://www.ecfr.gov/current/title-21/chapter-I/subchapter-H/part-801/subpart-D/section-801.109)
