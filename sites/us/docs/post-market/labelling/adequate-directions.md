---
sidebar_position: 2
title: Adequate Directions for Use
description: The FDA 'adequate directions for use' requirement — what it means, which devices are exempt, and how to comply.
keywords: [adequate directions for use, FDA labelling, prescription device, OTC device, 21 CFR 801.5]
---
...
Under **21 CFR § 801.5**, labelling must bear adequate directions for use — directions under which a **layperson** can safely use the device for the purposes for which it is intended.
...
## Prescription device exemption

Devices that are **restricted to sale by or on the order of a licensed practitioner** (prescription devices) are **exempt from the adequate directions for use requirement** under 21 CFR § 801.109 — because a layperson is not the intended end user.
...
## Exemption for OTC devices already in common use
