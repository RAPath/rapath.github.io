...
description: FDA MDR baseline reports — what they are, when they are required, and how to submit FDA Form 3417.
keywords: [baseline report, MDR baseline, FDA Form 3417, 21 CFR 803 baseline]
---
...
## When is a baseline report required?

Manufacturers must submit a baseline report when they submit the **first MDR** for a device — whether the first-ever MDR for that model, or the first MDR in a new calendar year for a device that has had prior MDRs.
...
## Official resources
- [FDA Form 3417 — MDR Baseline Report](https://www.fda.gov/media/69974/download)
- [21 CFR § 803.55](https://www.ecfr.gov/current/title-21/chapter-I/subchapter-H/part-803/subpart-E/section-803.55)
