...
description: FDA production and process control requirements under 21 CFR Part 820 (QMSR) — process validation, production procedures, environmental controls, and equipment calibration.
keywords: [production controls, process controls, 21 CFR 820, process validation, production procedures, equipment calibration, environmental monitoring]
---
...
| **§ 820.86** | Acceptance status — identification throughout manufacturing |
...
| Process | Why validation is required |
|---|---|
...
| Clean room operations | Contamination not always detectable |
| Software-controlled manufacturing | Automated process outcomes |
