...
description: FDA document and record control requirements under 21 CFR Part 820 (QMSR) — the Device Master Record (DMR), Device History Record (DHR), and general quality records.
keywords: [document control, record control, 21 CFR 820, Device Master Record, DMR, Device History Record, DHR, quality records]
---
