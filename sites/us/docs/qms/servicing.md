...
sidebar_position: 9
title: Servicing
description: FDA servicing requirements under 21 CFR Part 820 (QMSR) — when servicing applies, service records, and the boundary between servicing and remanufacturing.
keywords: [servicing, 21 CFR 820.200, device servicing, service records, remanufacturing, QMSR servicing]
---

# Servicing

## Regulatory basis — § 820.200

**21 CFR § 820.200** (QMSR) requires manufacturers to establish and maintain instructions and procedures for performing and verifying that the servicing meets the specified requirements, **when servicing is a specified requirement**.
...
## Service reports and MDR interface
...
| **Remanufacturing** | Significantly changing the device's performance, safety specs, or intended use | Treated as manufacturing — requires all manufacturer obligations including potentially a new 510(k) |
