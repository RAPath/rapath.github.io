---
sidebar_position: 5
title: IDE Clinical Investigation Pathway
description: The IDE pathway for conducting clinical investigations of unapproved medical devices in the USA — overview, application process, SR vs NSR, and integration with 510(k)/PMA submissions.
keywords: [IDE pathway, investigational device exemption, IDE application, significant risk, clinical investigation, FDA IDE]
---
...
## Quick reference — IDE pathway steps

```
1. Determine device risk level
       ├── Significant Risk (SR) → FDA IDE application required
       └── Non-Significant Risk (NSR) → Abbreviated IDE (IRB only)
                       ↓
...
3. Submit IDE application to FDA (SR devices)
   FDA review: 30 calendar days
                       ↓
4. Obtain IRB approval (all devices — SR and NSR)
                       ↓
