...
sidebar_position: 1
description: How Mexico's Reglamento de Insumos para la Salud defines a medical device, and which products fall under COFEPRIS jurisdiction.
---
...
1. **Manufactured, sold, or presented** for use in humans.
2. **Intended** for prevention, diagnosis, treatment, monitoring, or alleviation of disease, injury, or disability — or for investigation, replacement, or modification of anatomy or a physiological process.
3. **Does not achieve** its principal intended action by pharmacological, immunological, or metabolic means (distinguishing it from a medicine).

## COFEPRIS — the regulatory authority

**COFEPRIS** (Comisión Federal para la Protección contra Riesgos Sanitarios) is the federal body within the Ministry of Health (Secretaría de Salud) responsible for regulating medical devices. All devices placed on the Mexican market — manufactured domestically or imported — fall under COFEPRIS jurisdiction.
