---
title: Lifecycle of a Medical Device in Mexico
sidebar_position: 5
description: The end-to-end regulatory journey of a medical device in Mexico — from classification and registration through to post-market surveillance, renewal, and deregistration.
---
...
## Phase 1 — Classify your device

Before any submission, determine your device's risk class under the Reglamento de Insumos para la Salud:

- Class I — low risk (some require registration, some are exempt — see Annexes 1–3).
- Class II — medium risk.
- Class III — high risk (implants, life-sustaining devices).
...
## Phase 2 — Appoint a Mexico Registration Holder (MRH)
...
## Phase 3 — Choose your registration route
...
## Phase 4 — Prepare and submit your dossier
...
## Phase 6 — Post-market obligations begin
...
## Phase 8 — Post-approval modifications
