---
title: Multi-Market Submission Strategy
sidebar_position: 5
description: Strategic guidance for manufacturers planning to register medical devices in Mexico alongside or after other major markets — how to leverage existing approvals and documentation.
---
...
| Existing approval | Mexico pathway |
|---|---|
| FDA 510(k) / De Novo / PMA | Equivalency Route — 30-working-day target |
...
| No qualifying approval | Standard Route — 20–180 days by class |
...
- Technovigilance procedures and personnel — your MRH must have documented procedures, trained staff, and systems in place from day one of registration, as these are a condition of Aviso de funcionamiento and will be verified by COFEPRIS.
...
Add after the 'Prerequisite' box: 'Note: Minor differences such as packaging artwork, language variants (Spanish vs English), or regional labelling requirements do not disqualify a device, provided the functional design, materials, performance characteristics, and manufacturing process remain unchanged. When in doubt, request a pre-submission consultation (consulta previa) from COFEPRIS to confirm equivalency eligibility before investing in a full dossier.'
