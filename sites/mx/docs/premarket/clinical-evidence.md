...
sidebar_position: 5
description: What clinical data COFEPRIS expects for medical device registration in Mexico, how to use foreign clinical data, and clinical investigation requirements.
---
...
| Class | Expected clinical evidence |
|---|---|
| **Class I** | Literature review citing published data for similar devices; clinical evaluation summary |
| **Class II** | Clinical evaluation report; literature review; clinical study data for novel or higher-risk devices |
| **Class III** | Comprehensive clinical evaluation including prospective clinical study data; benefit–risk analysis |
