...
sidebar_position: 7
description: Regulatory pathways in Mexico for special device categories — combination products, custom devices, single-use devices, SaMD, IVDs, and export-only devices.
---
