---
title: Changing or Transferring Your MRH
sidebar_position: 4
description: How to transfer a COFEPRIS medical device sanitary registration from one Mexico Registration Holder to another — process, timelines, and risks.
---
...
1. **Notify the current MRH** of your intent to transfer.
2. **Identify and appoint a new MRH** that meets all legal requirements.
3. **Prepare transfer documentation** — new power of attorney, new MRH credentials, application for modification via DIGIPRiS.
4. **Submit a modification application** to COFEPRIS requesting the change of registration holder.
5. **COFEPRIS review and approval** — the registrations remain under the current MRH until COFEPRIS formally approves the transfer.
6. **Registration updated** — COFEPRIS updates the register to reflect the new MRH.
...
:::warning Protect yourself contractually
