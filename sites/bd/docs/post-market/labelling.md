...
sidebar_position: 3
description: DGDA labelling requirements for medical devices in Bangladesh — mandatory contents, Bengali language, IFU obligations.
---

# Labelling Requirements

> *DGDA · Drug and Cosmetics Act 2023 · Labelling*
...
- **Evidence-based** — claims of performance must be supportable by the clinical/performance data in the dossier

Claims that exceed the approved intended purpose — e.g., claiming treatment of a condition not covered in the registration — are prohibited and may trigger enforcement action.

## Labelling for Bangladesh Market

When adapting labelling for the Bangladesh market, ensure:
1. AR name and address is added as the local regulatory contact
2. Import information (import licence number where required) is correctly reflected
