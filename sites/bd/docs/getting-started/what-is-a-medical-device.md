...
sidebar_position: 1
description: Medical device definition under Bangladesh's Drug and Cosmetics Act 2023 — including explicit inclusion of software as a medical device.
---
...
|----------|----------------|
| Software that diagnoses disease from patient data | ✅ Yes |
| Software that monitors vital signs and alerts clinicians | ✅ Yes |
| Software controlling an active medical device | ✅ Yes |
| Administrative/billing/scheduling software | ❌ No |
| General wellness apps without medical claims | ❌ No |
| Electronic health record storage only | ❌ No |
...
:::tip Next step
Once you confirm your product is a medical device, determine its risk class. See [Classification Overview](/classification/overview).
:::
