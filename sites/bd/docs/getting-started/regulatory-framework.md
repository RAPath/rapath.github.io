...
sidebar_position: 2
description: How the DGDA regulates medical devices in Bangladesh — Ministry oversight, GHTF alignment, and the 2023 Act framework.
---

# Regulatory Framework Overview

> DGDA · Ministry of Health & Family Welfare · Drug and Cosmetics Act 2023
...
- Pricing oversight — the DGDA has a price-fixing role for drugs and devices
...
Verify the exact effective date with current DGDA guidance; the page states 18 September 2023, but confirm this matches the Government Gazette publication date and DGDA implementation announcements to ensure accuracy. is the governing legislation for medical devices. This Act:

- Replaced the legacy Drugs Act, 1940 — the most significant regulatory reform in Bangladesh in over 80 years
...
- Clarified local entity requirements — all registrations must be held by a Bangladesh entity
...
Bangladesh's classification and registration framework follows Global Harmonization Task Force (GHTF) guidance — the same framework adopted by many South and Southeast Asian markets. This means:

- Four-class risk system (A–D) consistent with GHTF/IMDRF principles
...
All DGDA device registrations must be held by a Bangladesh-registered entity. Foreign manufacturers cannot register directly. This local entity — the Authorized Representative (AR) — holds the registration licence and is fully accountable to the DGDA. See [Who Needs to Comply?](/getting-started/who-needs-to-comply) and [Import Licensing & Local Rep](/import-local-rep/overview).

## Quarterly Review Cycle — BD-Unique

A distinctive feature of the DGDA process is that application completeness is reviewed quarterly — not on a rolling basis. Applications received between review cycles queue until the next scheduled review. This means submission timing relative to the quarterly cycle can materially affect your registration timeline. See [Registration Timeline](/registration/timeline) for strategic guidance.

## Price Controls — BD-Unique
