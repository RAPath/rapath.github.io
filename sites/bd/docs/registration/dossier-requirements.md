...
sidebar_position: 2
description: Detailed documentation required for DGDA medical device registration — dossier contents for each class, FSC requirements, ISO 13485, clinical evidence, and CPP.
---
...
- Must comply with DGDA labelling requirements (see [Labelling Requirements](/post-market/labelling))
