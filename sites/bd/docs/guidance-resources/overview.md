...
sidebar_position: 1
description: Official DGDA guidance documents, ISO standards, QMS requirements, grouping rules, price controls, and resources for medical device registration in Bangladesh.
---

# Guidance & Resources

> *DGDA · ISO standards · QMS · Grouping · Price controls*

## Official DGDA Documents

| Document | Content | Where to Find |
|----------|---------|--------------|
| DGDA Registration Guidelines for Medical Devices | Full registration procedure, Annexure 1 (classification rules), documentation checklists | [www.dgda.gov.bd](https://www.dgda.gov.bd/) |
...
### ISO 13485 — Mandatory for Class B, C, D — BD-Unique
...
### DGDA Recognition of QMS Certificates

DGDA recognises ISO 13485 certificates from internationally accredited CBs. There is no separate DGDA-specific QMS approval process — a valid ISO 13485 certificate from any accredited CB is accepted.
...
- **Chemical, physical, and biological properties** — materials compatible with intended use; biocompatibility per ISO 10993
- **Infection and microbial contamination** — design minimises contamination risk; sterile devices meet appropriate standards
- **Construction and environmental properties** — performance maintained in expected use conditions
- **Devices with measuring functions** — accuracy and precision requirements
- **Protection against radiation** — radiation-emitting devices comply with applicable standards
- **Active devices** — electrical safety (IEC 60601 series), software reliability (IEC 62304)
...
| Same design principles | Shared design family — not fundamentally different designs |
...
**Confirm eligibility with the DGDA** before preparing a grouped application — not all multi-product submissions qualify.

## Price Controls — DGDA Price-Fixing Role — BD-Unique

The DGDA has statutory authority to **fix the prices of registered drugs and medical devices**. This means:

1. A registered device's selling price in Bangladesh is subject to DGDA approval
2. Price changes during the 5-year registration period may require DGDA notification or prior approval
3. ARs must ensure they do not sell above the DGDA-approved price
4. Violations of price-fixing orders can result in enforcement action
...
**Confirm current fees directly with the DGDA** — fees may change. The current schedule is available from the DGDA website or office.

## Official Source

All documents: **[DGDA Official Website — www.dgda.gov.bd](https://www.dgda.gov.bd/)**
