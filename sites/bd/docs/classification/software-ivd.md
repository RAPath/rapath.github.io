---
title: Software & IVD Classification
sidebar_position: 2
description: How DGDA classifies software as a medical device — the BD-unique "Drug" categorisation under the 2023 Act — and IVD classification rules.
---
...
4. **The AR holds the registration** — software developers must appoint a Bangladesh-based AR
...
High-severity condition + software output directly drives treatment = **Class C or D**
Low-severity condition + software provides background information = **Class A or B**
