...
sidebar_position: 4
description: "Equivalence-based clinical evaluation for Chinese medical device registration — comparing to a same-kind predicate device."
keywords: [substantial equivalence,same kind,同品种,NMPA,predicate device]
