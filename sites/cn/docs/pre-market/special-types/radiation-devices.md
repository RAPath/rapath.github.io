---
title: Radiation-Emitting Devices
sidebar_position: 8
description: "Additional requirements for radiation-emitting medical devices in China — MEE and CAEA approvals."
keywords: [radiation device,MEE,CAEA,NMPA,China]
tags: [pre-market,special-types]
---

# Radiation-Emitting Devices

*This page provides a plain English reference for radiation-emitting devices requirements under China's NMPA regulatory framework. Full content to be completed during editorial review.*

---

## Regulatory basis

Requirements for radiation-emitting devices are set out in:
