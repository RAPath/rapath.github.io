...
sidebar_position: 9
description: "China medical device registration certificate — validity, scope, changes, and re-registration."
keywords: [registration certificate,注册证,5 years,NMPA,China]
...
`国械注准[year]XXXXXXX` — national NMPA registration (Class III / imported)
`[Province code]械注准[year]XXXXXXX` — provincial registration (Class II domestic)
`国械注进[year]XXXXXXX` — imported device (older format)
