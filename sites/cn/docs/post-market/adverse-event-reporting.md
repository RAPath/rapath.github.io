...
sidebar_position: 2
description: "Adverse event reporting obligations and timeframes for medical device registrants in China."
keywords: [adverse event,reporting,NMPA,China,不良事件]
tags: [post-market]
---
...
Requirements for adverse event reporting are set out in MDSAR 2021 and implementing measures. See [Legislation & Regulations](/cn/docs/legislation/mdsar-2021) for the full legislative index.
