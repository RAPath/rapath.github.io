...
title: CAPA
sidebar_position: 5
description: "Corrective and preventive action requirements under China GMP and NMPA inspection expectations."
keywords: [CAPA,corrective action,NMPA,China,GMP]
tags: [qms]
---

# CAPA

*This page provides a plain English reference for capa under China's NMPA regulatory framework. Full content to be completed during editorial review.*
