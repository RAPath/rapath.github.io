---
title: NBTC Approval for Wireless Devices
sidebar_position: 2
description: NBTC (National Broadcasting and Telecommunications Commission) approval requirements for wireless medical devices in Thailand — separate from Thai FDA.
---
...
| Technology | NBTC Required? |
|-----------|---------------|
| Wi-Fi (802.11 a/b/g/n/ac/ax) | ✅ Yes |
| Bluetooth (all versions including BLE) | ✅ Yes |
| Cellular (3G/4G/5G/LTE) | ✅ Yes |
| RFID (radio frequency identification) | ✅ Yes |
| Zigbee / Z-Wave / other sub-GHz RF | ✅ Yes |
| ANT / ANT+ | ✅ Yes |
| Satellite communication modules | ✅ Yes |
| NFC (near field communication) | Confirm with NBTC |
| Infrared (IR) — non-RF | ❌ Generally no |
| Wired ethernet / USB only | ❌ No |

## NBTC vs Thai FDA — Two Independent Processes

| Aspect | Thai FDA / MDCD | NBTC |
|--------|----------------|------|
| What it covers | Safety and performance of the medical device | Radio frequency spectrum and communications |
| Authority | Ministry of Public Health | Independent telecommunications regulator |
| Application | Via Thai FDA e-submission | Via NBTC portal / direct application |
| Can one substitute the other? | ❌ No — both required | ❌ No — both required |

## NBTC Approval Process
...
- FCC standards (US) — in many cases accepted with Thai-specific modifications
...
| Process | Typical Duration | Recommendation |
|---------|-----------------|----------------|
