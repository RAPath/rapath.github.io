---
title: SaMD, Combination Products & Special Classifications
sidebar_position: 2
description: Thai FDA classification of software as a medical device, combination drug-device products, wireless devices, and other special categories.
---
...
**High-severity condition + software directly drives treatment → Class 3 or 4**
**Low-severity + informational output → Class 1 or 2**
...
**Drug-eluting stents:** Typically classified as medical devices internationally — confirm with MDCD.
**Contrast agents:** Classified as pharmaceuticals.
...
1. **Thai FDA / MDCD** — standard Listing/Notification/License pathway
2. **NBTC (National Broadcasting and Telecommunications Commission)** — approval for the radio frequency spectrum/communications aspect
...
**NBTC website:** [www.nbtc.go.th](https://www.nbtc.go.th/)
...
Add after the 'principal intended action' definition: 'Thai FDA Guidance: When the principal action is unclear, manufacturers may request a pre-submission meeting with the MDCD to obtain a written determination before proceeding with full application preparation. This formal clarification is strongly recommended for combination products to avoid rejection or reclassification during review.'

Expand the custom-made devices section: 'Custom-Made Devices Exemption: Devices manufactured for a specific individual patient on a clinician's written prescription may be exempt from standard Thai FDA registration. To qualify: (1) the device must be uniquely designed for that patient, (2) a written prescription from a licensed clinician must be on file, (3) manufacturing must be documented with traceability. Contact the MDCD for a formal exemption determination and documentation requirements. This exemption does not apply to devices manufactured in batches for potential future use.'
