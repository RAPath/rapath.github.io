---
title: Labelling & Language Requirements
sidebar_position: 2
description: Thai FDA labelling requirements — MoPH Notification 137, Thai language mandate for home-use devices, 180-day grace period for label affixing.
---
...
| License holder (AR/importer) name and address | Required — Thai regulatory contact |
| Thai FDA approval number | Required — the Listing/Notification/License reference |
