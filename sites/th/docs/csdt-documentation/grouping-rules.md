...
sidebar_position: 2
description: Thailand CSDT grouping rules — Single device, Family, System, Set, IVD Test Kit, and IVD Cluster — eligibility criteria and examples.
---

# Grouping Rules

> *TH-Unique · ASEAN CSDT grouping · Multiple devices in one application*
...
## The Six Grouping Types — TH-Unique

Thailand's CSDT framework recognises six distinct grouping types:

### 1. Single Device
A single specific model/configuration. The baseline — not a grouping type per se, but the reference point for all other types.
...
**Eligibility check:** If you change the material, intended purpose, or operating principle between models, they cannot form a Family — they require separate applications.
...
- Not necessarily integrated — may be individual devices in a procedure pack
...
**Examples:**
- Serum-based ELISA + whole blood rapid test — both testing for the same hepatitis B antigen
- Professional-use PCR kit + point-of-care rapid test — same target analyte, different platforms for different settings

## Grouping Eligibility Requirements — Common to All Types
...
1. Select the appropriate grouping type
2. List all models/variants to be included with their full model identifiers
3. Provide a table comparing specifications across all variants (showing shared features and allowed differences)
4. Prepare a single CSDT covering all models in the group
5. Include separate labelling/IFU for each variant where labelling differs

:::info Grouping reduces but doesn't eliminate documentation
