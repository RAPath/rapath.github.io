---
title: CSDT & Technical Documentation
sidebar_position: 1
description: Thailand CSDT Full format for Class 2–4 devices — all sections explained, QMS requirements, essential principles compliance, and clinical evidence.
---

# CSDT & Technical Documentation

> *TH-Unique · Common Submission Dossier Template · ASEAN AMDD aligned*
...
## CSDT Full Format — For Class 2, 3, and 4

The **CSDT Full format** is required for all Notification (Class 2–3) and License (Class 4) applications. Class 1 Listing uses a simplified form.
...
| **Risk management** | ISO 14971 summary — hazard identification, controls, residual risk |
| **Clinical / performance evaluation** | CER (general devices) or performance evaluation report (IVDs) |
| **Labelling** | Proposed Thai labelling and IFU — compliant with MoPH Notification 137 |
| **QMS evidence** | ISO 13485 certificate — valid, scope-appropriate, accredited CB |
| **Manufacturing information** | Manufacturing site details, GMP evidence |
| **Post-market surveillance plan** | PMS commitments for Class 3–4 |

## QMS Requirements — ISO 13485
...
Thai FDA recognises certificates from internationally accredited CBs — no separate Thai FDA QMS approval process.
...
| Active devices — electrical safety | IEC 60601-1 and sub-parts |
...
- Benefit-risk analysis — benefits must outweigh residual risks
...
Overseas clinical data is accepted where the patient population, disease epidemiology, and intended use are equivalent to Thai context. However, the Thai FDA may request additional bridging data or comparative studies if significant demographic, epidemiological, or use-pattern differences exist between the source population and Thai patients.

## In-Country Testing — TH-Unique

For certain device categories, Thai FDA may require **local testing** to be conducted in Thailand:
- High-risk IVDs — potential requirement for local testing
- Medical gloves — local testing may be required
...
Replace the incomplete paragraph: "Overseas clinical data is accepted where the patient population, disease epidemiology, the Thai FDA may request additional data or bridging studies if significant demographic or epidemiological differences exist. and intended use are equivalent to Thai context." with: "Overseas clinical data is accepted where the patient population, disease epidemiology, and intended use are equivalent to Thai context. However, the Thai FDA may request additional data or bridging studies if significant demographic or epidemiological differences exist."
