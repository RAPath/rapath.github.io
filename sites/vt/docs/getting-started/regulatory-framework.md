...
description: An overview of Vietnam's medical device regulatory system — MOH, DAV, provincial health departments, and the Decree 98/2021 structure.
---
...
The **National Medical Device Information System (DMEC)** at [dmec.gov.vn](https://dmec.gov.vn) is the central online portal for all regulatory submissions — Type A/B declarations, Type C/D registration applications, import permit requests, and post-market reporting.
