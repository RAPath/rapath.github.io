...
For the consolidated English translation (if available) or to verify amendment status, consult the official sources listed above or contact your Authorised Representative. Note: The official version is in Vietnamese; English translations are for reference only and should not be relied upon for regulatory compliance.

Add to the 'Official source' section: 'For the consolidated English translation (if available) or to verify amendment status, consult the official sources listed above or contact your Authorised Representative. Note: The official version is in Vietnamese; English translations are for reference only and should not be relied upon for regulatory compliance.'

Note: The official version of Decree 98/2021 and all amendments is in Vietnamese. English translations are available from various sources but may vary in accuracy and completeness. For regulatory compliance, always refer to the official Vietnamese text. If you require an English translation, request one from your Authorised Representative or DAV, as unofficial translations should not be relied upon for legal interpretation.
