...
description: Post-market surveillance (PMS) requirements for medical devices in Vietnam — PMS plans, complaint handling, trend analysis, and periodic reporting.
---
...
- **Objectives** — what safety and performance data is being monitored
- **Data sources** — complaint database, literature surveillance, registry data, adverse event reports, field service data
- **Methods** — how data will be collected, analysed, and assessed against predefined thresholds
- **Responsible parties** — who within the manufacturer's organisation owns each activity
- **Frequency** — how often PMS data is reviewed
- **Escalation criteria** — what signals will trigger a deeper investigation or FSCA
