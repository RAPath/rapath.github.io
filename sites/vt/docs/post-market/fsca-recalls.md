...
sidebar_position: 3
title: FSCA & Recalls
description: Field Safety Corrective Actions (FSCA) and recall procedures for medical devices in Vietnam, including notification to DAV and provincial health departments.
---
...
An FSCA may involve:
- **Device recall** — removing devices from the market and/or the field
- **Device correction** — modification, adjustment, relabelling, or software update of devices in the field
- **User advice** — advising users of risks and precautions without physical action on the device
...
- Scope of the FSCA — number of devices affected, distribution countries
...
## Notifying provincial health departments

In addition to DAV, the Authorised Representative or local distributor must coordinate notification with the relevant **provincial health departments (Sở Y tế)** in provinces where affected devices are distributed. Provincial health departments are the primary link to healthcare facilities receiving the FSN.
...
- Clearly identify the affected device(s) — name, model, serial/lot numbers
