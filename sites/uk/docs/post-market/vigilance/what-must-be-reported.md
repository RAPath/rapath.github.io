---
sidebar_position: 1
title: What must be reported to MHRA
description: >
  The events that trigger mandatory vigilance reporting under the UK MDR 2002 — serious incidents,
  FSCAs, trend reports, and the criteria for determining whether an event is reportable.
tags: [uk-mdr, vigilance, post-market, adverse-events]
---
