...
description: >
  PSUR requirements for Class IIa, IIb, III, AIMD, and higher-risk IVDs under the UK MDR 2002 —
  what a PSUR must contain, frequency, relationship to PMS data, and UKAB access requirements.
tags: [uk-mdr, psur, post-market-surveillance, post-market]
---
...
| Device class | Minimum PSUR frequency |
|---|---|
| Class IIa | At least every 2 years |
| Class IIb | At least annually |
| Class III | At least annually |
| AIMD | At least annually |
| IVD List B | At least every 2 years |
| IVD List A | At least annually |
| IVD Self-test | At least every 2 years (if UKAB involved) |
