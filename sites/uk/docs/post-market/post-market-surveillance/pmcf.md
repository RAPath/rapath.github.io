...
description: >
  PMCF requirements for medical devices under the UK MDR 2002 — what PMCF is, when it is
  required, PMCF plan and report structure, methods, and how PMCF data feeds back into the
  clinical evaluation.
tags: [uk-mdr, pmcf, post-market-surveillance, post-market, clinical-evidence]
---
