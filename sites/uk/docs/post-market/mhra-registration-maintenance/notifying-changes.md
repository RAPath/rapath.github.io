---
sidebar_position: 2
title: Notifying changes to MHRA
description: >
  Which changes to a device, its manufacturer, or its UKRP must be formally notified to MHRA —
  and which changes are handled through registration update vs. separate notification.
