...
**7. Certificate decision**
UKAB reviews all findings and decides whether to issue the certificate. For Class III devices: Design Examination Certificate issued per device design; QMS Certificate issued per quality system.
