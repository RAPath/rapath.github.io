...
description: >
  The legal definition of an in vitro diagnostic medical device (IVD) under Part III of the UK Medical
  Devices Regulations 2002, IVD classification categories, and how IVD regulation differs from general
  medical devices.
tags: [uk-mdr, ivd, definition, fundamentals]
---
...
> reagent, reagent product, calibrator, control material, kit, instrument, apparatus, equipment or system — whether used alone or in combination — **intended by its manufacturer to be used in vitro for the examination of specimens derived from the human body**, including blood and tissue donations.
...
Specimen collection containers — even though not analytical themselves — are also regulated as IVDs under Part III if intended for the collection and preservation of specimens for IVD examination.

---

## Why IVDs are regulated separately
...
Because the risk is informational rather than physical, IVDs are assessed differently — the key metrics are **analytical performance** (accuracy, precision, specificity, sensitivity) and **clinical performance** (what the test result means for patient management).

---

## UK IVD classification

Unlike general medical devices — which use Classes I, IIa, IIb, and III — IVDs under UK MDR 2002 Part III use a different four-category system based on the **Annex II lists** and the concept of self-testing:
...
### Annex II List A — the highest-risk IVDs
...
- Reagents for phenylketonuria (PKU) — neonatal screening
- Reagents for congenital hypothyroidism screening
- Human chorionic gonadotropin (hCG) — pregnancy testing (professional use)
...
Any IVD — regardless of whether it would otherwise be List A, List B, or General — that is **specifically designed and intended for use by lay persons in a home setting** is a self-test device and subject to specific labelling, instructions, and performance requirements.
...
| **EU IVDR 2017/746 (EU & NI market)** | Class A / B / C / D (new risk-based classification, Annex VIII Rules 1–7) |
...
- **Analytical performance** — sensitivity, specificity, accuracy, precision, limits of detection, measuring range, linearity, cut-off determination
- **Clinical performance** — diagnostic sensitivity, diagnostic specificity, positive predictive value, negative predictive value in the intended population
- **Scientific validity** — the relationship between the analyte and the clinical state being diagnosed
...
- A general-purpose label → not an IVD
- A label claiming it is intended for clinical diagnostic use → potentially an IVD
