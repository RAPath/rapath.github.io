---
sidebar_position: 8
title: Lifecycle of a medical device in the UK
description: >
  A stage-by-stage overview of the regulatory lifecycle of a medical device in Great Britain —
  from concept and classification through pre-market conformity assessment and MHRA registration
  to post-market surveillance, vigilance, and end-of-life obligations under the UK MDR 2002.
tags: [uk-mdr, lifecycle, fundamentals, pre-market, post-market]
---
...
Before placing any device on the GB market, the manufacturer (or their UKRP) must **register with MHRA** via the [MHRA Submissions portal](https://submissions.mhra.gov.uk/).
