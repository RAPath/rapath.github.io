---
sidebar_position: 7
title: Borderline & combination products
description: >
  How MHRA approaches products that sit on the boundary between medical devices and other regulatory
  frameworks — medicines, cosmetics, biocides — and how drug-device combination products are
  regulated under the UK Medical Devices Regulations 2002.
tags: [uk-mdr, borderline, combination-products, definition, pre-market]
---

:::note[Regulatory basis]
Borderline determinations flow from the **definition of a medical device in Regulation 2(1) of the UK MDR 2002** and the definition of a medicinal product in the **Human Medicines Regulations 2012**. Drug-device combination product rules are in **Regulation 7A of UK MDR 2002** (inserted post-Brexit). MHRA publishes borderline guidance at [gov.uk/government/publications/borderline-products-guidance-for-manufacturers](https://www.gov.uk/government/publications/borderline-products-guidance-for-manufacturers).
:::
...
A **borderline product** is any product that sits at the boundary between the medical device regulatory framework and another regulatory framework — most commonly:
...
## The device-medicine boundary

This is the most clinically significant — and most frequently litigated — borderline question.

### The principal mode of action test

The fundamental test is the **principal mode of action**:

- If the product achieves its principal intended action through **pharmacological, immunological, or metabolic means** → **medicinal product** regulated under the Human Medicines Regulations 2012
- If the product achieves its principal intended action through **physical, mechanical, or other non-pharmacological/immunological/metabolic means** → **medical device** regulated under UK MDR 2002
...
### What "principal mode of action" means in practice

The principal mode of action is the mechanism by which the product achieves its **primary** intended therapeutic or diagnostic effect — not an ancillary or secondary effect.

| Product | Principal mode of action | Regulatory status |
|---|---|---|
| Coronary stent (bare metal) | Mechanical — holds vessel open | Medical device |
...
| Antibiotic injection | Pharmacological — kills bacteria systemically | Medicinal product |
| Hyaluronic acid dermal filler (cosmetic) | Mechanical — volume restoration | Not regulated as MD or medicine in GB (no Annex XVI) |
| Hyaluronic acid intra-articular injection (osteoarthritis) | Mechanical — joint lubrication | Medical device |
| Topical antiseptic cream (wound management, device function claimed) | Barrier + antimicrobial | Borderline — depends on specific claims |
| Nicotine patch | Pharmacological — nicotine delivery through skin | Medicinal product |
| Nicotine replacement gum (no NRT claim, sold as "oral care") | Borderline — may be food or medicine depending on claims | Requires case-by-case assessment |

### MHRA's approach to the boundary

When a product's principal mode of action is genuinely unclear, MHRA will assess:

1. **The specific claims made** — labelling, IFU, marketing materials, website, social media
2. **The scientific evidence** — what does the mechanism of action evidence show is the predominant effect?
3. **Regulatory precedent** — how have similar products been categorised previously?
4. **International consensus** — MHRA considers EU and FDA positions, though it is not bound by them post-Brexit
...
### How combination products are regulated in the UK
...
#### If the device is the principal element (device-led):
...
#### If the medicine is the principal element (medicine-led):
...
### Pre-filled syringes and drug delivery systems
...
## Device-cosmetic boundary

### The general principle

Cosmetic products are regulated under the **UK Cosmetics Regulation (Retained Regulation (EC) No 1223/2009)**. A product whose **sole purpose** is to clean, perfume, change appearance, or protect the body for cosmetic effect is a cosmetic — not a medical device — even if it has an indirect effect on health.

### When cosmetics become medical devices
...
| Sunscreen | "Prevents skin cancer in high-risk patients" | Medicinal product claim — enforcement risk |
...
- A **biocidal product** — if intended to destroy microorganisms in the environment or on non-living surfaces for the primary purpose of disinfection
- A **medical device** — if the antimicrobial function is ancillary to a primary device function (e.g., an antibiotic-impregnated catheter where the catheter's physical properties are the primary mode of action)
- A **medicinal product** — if intended to kill microorganisms within the living human body through systemic pharmacological action
...
## Seeking a borderline opinion from MHRA

Manufacturers with genuine uncertainty about whether their product is a medical device — or how it should be classified at the device/medicine/cosmetic boundary — can seek an informal opinion from MHRA through its **pre-submission meeting service**:

- **Who can apply**: Any manufacturer, regulatory consultant, or UKRP with a genuine borderline question
- **What is provided**: MHRA's informal view on the product's likely regulatory status — not a binding legal determination
- **How to apply**: Via [MHRA's pre-submission service](https://www.gov.uk/guidance/pre-submission-meetings-for-medical-devices)
- **Turnaround**: Variable — typically several weeks
...
Complete the drug-device combination products section: "A drug-device combination product is an integral presentation of a medical device and a medicinal substance, where both components contribute to the product's purpose and function. Under UK MDR 2002 Regulation 7A, the regulatory route depends on which component is deemed principal: If the device is the principal component: The product is regulated primarily as a medical device under UK MDR 2002, with the medicinal component assessed for safety and efficacy. If the medicinal substance is the principal component: The product is regulated primarily as a medicinal product under the Human Medicines Regulations 2012, with the device component assessed for quality and performance. Manufacturers must apply to both MHRA (medical devices) and MHRA (medicines) for guidance on the appropriate regulatory pathway. The determination is made on a case-by-case basis and must be documented in the regulatory strategy."
