...
The Essential Requirements section should be completed. Based on UK MDR 2002 Part II Schedule 1, add: "Electrical safety: The device must be designed to minimize risks from electrical hazards, including leakage current, insulation breakdown, and electromagnetic interference. Mechanical safety: The device must be mechanically sound and resistant to rupture or fragmentation during normal use and foreseeable misuse. Biological properties: The device must be biocompatible with implanted tissues and materials must not cause toxic, carcinogenic, mutagenic, or allergenic reactions. Performance: The device must perform reliably over its intended lifetime, including battery life specifications and means to alert the user before battery depletion. Risk management: The device must be designed using a risk management approach per ISO 14971 adapted for implantable active devices. Labelling and instructions: The device must include clear instructions for use, including information on implantation, operation, monitoring, maintenance, and explantation where applicable."
