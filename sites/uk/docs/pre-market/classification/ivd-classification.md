---
sidebar_position: 4
title: IVD classification — List A · List B · Self-test · General
description: >
  IVD medical device classification under Part III of the UK Medical Devices Regulations 2002 —
  Annex II List A, Annex II List B, self-test devices, and general IVDs, with conformity assessment
  requirements for each category and comparison with EU IVDR Class A–D.
tags: [uk-mdr, ivd, classification, list-a, list-b, self-test, pre-market]
---
...
1. **EC Design Examination (Annex IV equivalent)** — the UKAB examines the device design, including analytical and clinical performance data, and issues a Design Examination Certificate
2. **Production Quality Assurance (Annex VII equivalent)** — the UKAB audits the manufacturer's production QMS to confirm consistent manufacturing
3. Alternatively: **Full Quality Assurance (Annex VI equivalent)** — a single UKAB audit covering both design and production quality systems
...
1. **EC Type-Examination (Annex V equivalent)** — UKAB examines a representative specimen of the device; followed by production surveillance (Annex V, VI, or VII)
2. **Full Quality Assurance (Annex VI equivalent)** — UKAB audits the full QMS covering design and production
...
1. Many GB-based manufacturers also serve the EU/NI market
2. EU IVDR upclassified many previously "General" IVDs to Class B or C, requiring EU Notified Body involvement for EU/NI
3. MHRA's reform programme may introduce an IVDR-like classification system for GB in future
