---
sidebar_position: 2
title: Class I · IIa · IIb · III
description: >
  Overview of the four risk classes for general medical devices under the UK Medical Devices
  Regulations 2002 — what defines each class, UKAB requirements, conformity assessment routes,
  and practical examples of devices in each class.
tags: [uk-mdr, classification, class-i, class-iia, class-iib, class-iii, pre-market]
---
...
1. UKAB audits the manufacturer's full QMS (design, manufacture, production, post-market)
2. UKAB examines the design dossier (a subset of the technical file with additional design-stage information)
3. UKAB issues a Design Examination Certificate covering the device design
4. UKAB issues a QMS Certificate covering the quality system
5. Manufacturer issues UK Declaration of Conformity referencing both certificates
6. UKCA mark applied
