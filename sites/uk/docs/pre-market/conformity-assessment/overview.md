---
sidebar_position: 1
title: Conformity assessment — overview & route selection
description: >
  How conformity assessment works under the UK MDR 2002 — the available routes by device class,
  the role of UK Approved Bodies, how to select the right route, and what the process produces.
tags: [uk-mdr, conformity-assessment, ukab, ukca, pre-market]
---

:::note[Regulatory basis]
Conformity assessment procedures are set out in **Schedule 3** of the UK MDR 2002 (Part I general devices), **Part II Schedule 3** (AIMDs), and **Part III Annexes IV–VII** (IVDs). The outcome of conformity assessment is the **UK Declaration of Conformity** and (for certified devices) the **UKAB certificate**, authorising the UKCA mark.
:::
...
1. The manufacturer issues a **UK Declaration of Conformity**
2. The manufacturer affixes the **UKCA mark** to the device and its packaging
3. For devices requiring a UKAB: the UKAB issues a **certificate** that the manufacturer references in the Declaration of Conformity

Conformity assessment is the manufacturer's **legal obligation** — not the UKAB's. The UKAB provides third-party verification for higher-risk devices, but the manufacturer bears primary responsibility throughout.

---

## Route selection by device class

The conformity assessment route is determined by the device's class:

### General medical devices (Part I)

| Class | Conformity assessment route | UKAB involvement |
|---|---|---|
| **Class I** (standard) | Schedule 3, Annex VII equivalent — self-declaration | None |
...
### Active implantable devices (Part II)
...
### IVD medical devices (Part III)

| Category | Route | UKAB involvement |
|---|---|---|
| **General IVDs** | Annex VII equivalent — self-declaration | None |
...
## The Schedule 3 conformity assessment modules

Schedule 3 of UK MDR 2002 sets out the conformity assessment procedures, organised as modules (labelled as "Annexes" in the legislative text — retained from the EU MDD structure):
...
For Class III and AIMDs, Annex II additionally requires **design dossier examination** — the UKAB formally reviews the device design and issues a Design Examination Certificate.
...
- **Annex IV (production quality assurance)** — UKAB audits the production QMS
- **Annex V (product quality assurance)** — UKAB verifies product samples against the type
- **Annex VI (declaration of conformity)** — manufacturer self-declares ongoing conformity based on the type-examination

**Suitable for:** Class IIa, IIb. Less commonly used for Class III (Annex II is preferred).

### Annex IV — Production quality assurance
...
UKAB performs statistical product verification — examining and testing samples from each production batch. Less common; used where ongoing QMS assessment is not feasible (e.g., very small manufacturers).

### Annex VI — Declaration of conformity based on type-examination
...
### Annex VII — Manufacturer's declaration (self-declaration)
...
## Choosing between Annex II and Annex III for IIa/IIb devices
...
Most manufacturers with a range of devices prefer Annex II — a single QMS certificate covering the entire product portfolio is simpler to manage than multiple type-examination certificates.

---

## The conformity assessment application process

For devices requiring UKAB assessment, the process typically follows these stages:

### 1. Pre-assessment/feasibility review
...
### 3. Document review (desktop audit)

The UKAB performs a **document review** — assessing the technical file against the applicable ERs and Schedule 3 requirements. Review findings are issued as a list of observations and non-conformities (NCs).

NCs are categorised:
- **Major NC** — must be resolved before certification; represents a significant deficiency in ER conformity
- **Minor NC** — must be resolved within an agreed timeframe; does not block initial certification
- **Observation** — noted for attention; no formal response required

### 4. On-site audit (for Annex II QMS routes)
...
### 5. Design examination (for Class III / AIMD)
...
The manufacturer issues a **UK Declaration of Conformity** — signed and dated — declaring that the device meets all applicable ERs, and referencing the UKAB certificate(s) where relevant.
...
- [Class IIa · IIb · III — UKAB routes](./ukab-routes)
...
| UK MDR 2002, Part III, Annexes IV–VII | IVD conformity assessment routes |
