...
description: >
  What a UK Declaration of Conformity is, what it must contain, who signs it, how it differs from
  an EU Declaration of Conformity, and how to maintain it throughout the device lifecycle under
  the UK MDR 2002.
tags: [uk-mdr, conformity-assessment, declaration-of-conformity, pre-market]
---
...
## Required contents of the UK DoC

While the UK MDR 2002 does not specify a mandatory template, the UK DoC must contain sufficient information to:

1. **Identify the device:** Name, model number(s), intended purpose, device description, and any variants covered
2. **Identify the manufacturer:** Full legal name and registered address
3. **Identify the UKRP** (where applicable): Full legal name and registered address in Great Britain
4. **State the conformity assessment procedure used:** Reference to the specific Schedule 3 annex(es) applied (e.g., "Conformity assessed in accordance with Annex II equivalent procedure under Schedule 3 of the UK MDR 2002")
5. **Identify the UKAB** (where applicable): Name, address, and UKAB identification number; certificate number and date of issue
6. **Declare conformity with applicable Essential Requirements:** Reference to Schedule 1 or Schedule 1A of UK MDR 2002
7. **List applicable UK-designated standards and/or Common Specifications applied**
8. **Be signed and dated** by a person authorised to act on behalf of the manufacturer, with their name and title
9. **Bear the date** of issue

### Example UK DoC structure
...
## UK DoC vs EU Declaration of Conformity
...
Under the CE marking transitional acceptance (until 30 June 2030), a manufacturer can use their EU DoC for GB market access — they do not need a separate UK DoC during this period, **provided** they also complete MHRA registration.

---

## Maintaining the UK DoC
...
## Who can sign the UK DoC?

The UK DoC must be signed by a person who has the authority to bind the manufacturer — typically:
...
## DoC and the UKCA mark

The UKCA mark may only be affixed to a device **after** the UK DoC has been issued. The UKCA mark signals to the market that:
1. A UK DoC exists
2. The conformity assessment procedure has been completed
3. The device meets the applicable Essential Requirements

The UKCA mark and the UK DoC are inseparable — one cannot exist without the other.
...
| EU MDR 2017/745, Annex IV | EU DoC requirements (for NI/EU — comparative reference) |
