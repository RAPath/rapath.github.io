---
sidebar_position: 4
title: IVD Essential Requirements (Schedule 1A)
description: >
  The Essential Requirements specific to in vitro diagnostic medical devices under Schedule 1A of
  Part III of the UK Medical Devices Regulations 2002 — analytical performance, clinical performance,
  labelling, and instructions for use requirements.
tags: [uk-mdr, ivd, essential-requirements, performance-evaluation, pre-market]
---
...
IVD medical devices have Essential Requirements that reflect the nature of in vitro testing: the device does not interact physically with the patient, but its output — the test result — directly or indirectly influences clinical decisions. The Schedule 1A ERs therefore focus heavily on **analytical and clinical performance** rather than physical safety alone.

---

## Section I: General requirements (also apply to IVDs)

The six general ERs in Schedule 1, Section I of UK MDR 2002 apply to IVDs as well as general devices. In the IVD context:

- **ER 1 (safety)** — an IVD that produces a false result that causes a patient to be over-treated or under-treated is not safe for its intended purpose
- **ER 2 (risk management)** — risk management for IVDs must address analytical failures (false positives, false negatives), operator errors, and misinterpretation risks
- **ER 3 (performance as intended)** — the IVD must achieve the analytical and clinical performance stated by the manufacturer
- **ER 6 (acceptable side effects)** — for IVDs, this translates to acceptable rates of misdiagnosis, given clinical context

---

## Schedule 1A Section I: Design and manufacturing requirements
...
## Schedule 1A Section II: Analytical and clinical performance

This is the most technically demanding section of Schedule 1A — the manufacturer must establish and document the **analytical performance characteristics** and **clinical performance** of the IVD.
...
## Schedule 1A Section III: Calibration and quality control
...
## Schedule 1A Section IV: Labelling and IFU requirements for IVDs
...
### IFU requirements for IVDs (minimum content)

1. **Intended use and clinical significance** — what the test is for and what the result means clinically
2. **Principle of the procedure** — how the assay works (immunoassay, PCR, etc.)
3. **Analytical performance data** — sensitivity, specificity, precision, linearity, reference range
4. **Clinical performance data** — diagnostic sensitivity, specificity, PPV/NPV in relevant populations
5. **Limitations and interferences** — substances that may affect the result (haemolysis, lipaemia, drugs, cross-reacting antibodies)
6. **Specimen type and collection** — acceptable specimens, collection method, additives, rejection criteria
7. **Specimen transport and storage** — conditions, maximum holding times
8. **Instructions for use** — step-by-step procedure
9. **Quality control requirements** — recommended QC frequency and interpretation
10. **Calibration instructions** — frequency, acceptable calibrators, how to verify calibration
11. **Reference intervals / expected values** — for the intended population
12. **What to do with a borderline or equivocal result**
13. **Precautions** — safety precautions for handling human specimens

### Self-test IVD IFU requirements
...
## Demonstrating conformity with Schedule 1A

### Performance evaluation plan and report

The analytical and clinical performance data required by Schedule 1A is compiled in a **Performance Evaluation Plan (PEP)** and **Performance Evaluation Report (PER)** — the IVD equivalent of the Clinical Evaluation Plan and Clinical Evaluation Report for general medical devices.
...
|---|---|
| UK MDR 2002, Part III, Schedule 1A | IVD Essential Requirements — full text |
