...
description: >
  The regulatory framework for single-use medical devices in the UK — mandatory labelling,
  the prohibition on reprocessing and reuse, and the specific requirements for manufacturers
  who place reprocessed single-use devices on the GB market.
tags: [uk-mdr, single-use, special-device-types, pre-market]
---
