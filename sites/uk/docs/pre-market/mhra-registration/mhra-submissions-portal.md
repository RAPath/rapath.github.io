---
sidebar_position: 2
title: Registration via the MHRA Submissions portal
description: >
  Step-by-step guide to completing device registration via the MHRA Submissions portal —
  account setup, registration workflow, required information, and common issues.
tags: [uk-mdr, mhra-registration, pre-market]
---

:::note[Regulatory basis]
Registration via the MHRA Submissions portal is mandatory under the **UK MDR 2002 as amended**. The portal is at [submissions.mhra.gov.uk](https://submissions.mhra.gov.uk/).
:::
...
1. Navigate to [submissions.mhra.gov.uk](https://submissions.mhra.gov.uk/)
2. Select "Register" / "Create an account"
3. Enter your organisation's legal name, address, and a contact email
