---
sidebar_position: 3
title: Device-level registration requirements
description: >
  What information must be provided at the device level when registering with MHRA — device
  descriptions, classification, certificate references, and the distinction between registering
  a device family vs individual models.
