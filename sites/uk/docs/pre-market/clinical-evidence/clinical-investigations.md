---
sidebar_position: 3
title: Clinical investigations in the UK
description: >
  How to conduct a clinical investigation of a medical device in the UK — MHRA notification,
  ethics committee approval, protocol requirements, adverse event reporting, and post-investigation
  obligations under the UK MDR 2002.
tags: [uk-mdr, clinical-investigations, clinical-evidence, pre-market]
---
...
1. Sufficient clinical evidence can be obtained from literature and equivalent device data, **and**
2. The device is not a novel technology or intended purpose where existing data is insufficient
