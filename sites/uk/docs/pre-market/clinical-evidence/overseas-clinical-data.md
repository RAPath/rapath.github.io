...
description: >
  How clinical data generated outside the UK — from EU, US, Japanese, Australian, Canadian, or
  other investigations and studies — can be used to support clinical evaluation under the UK
  MDR 2002.
tags: [uk-mdr, clinical-evidence, clinical-evaluation, pre-market]
---
...
1. The study was conducted to appropriate quality standards (GCP, ISO 14155, or equivalent)
2. The data is relevant to the device's intended purpose and the intended patient population
3. The data has been critically appraised (not just cited uncritically)
4. Any differences between the overseas study population and the UK intended population are considered and addressed
