...
description: >
  What clinical evaluation entails for medical devices under the UK MDR 2002 — the clinical
  evaluation process, literature-based evidence, equivalent device approach, clinical
  investigations, and ongoing post-market clinical follow-up (PMCF).
...
:::tip[EU MDR raised the bar on equivalence]
