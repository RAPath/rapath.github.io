---
sidebar_position: 2
title: Performance evaluation for IVDs
description: >
  Performance evaluation requirements for IVD medical devices under Part III of the UK MDR 2002 —
  analytical performance, clinical performance, scientific validity, and the Performance
  Evaluation Report (PER).
tags: [uk-mdr, ivd, performance-evaluation, clinical-evidence, pre-market]
---
